    ...
    public static Session openSession(final Connector connector) {
        ...
        try {
            ...
            Logger.warn(
                    ...
                    "Extra",
                    e,
                    "JSch session creation failed: hostPresent={}, port={}, timeoutMs={}, exception={}",
    ...
    public static Channel openChannel(final Session session, final ChannelType channelType, final long timeout) {
        ...
        try {
            ...
            Logger.warn(
                    ...
                    "Extra",
                    e,
                    "JSch channel connect failed: channelType={}, timeoutMs={}, exception={}",
                    channelType,
                    timeout,
                    e.getClass().getSimpleName());
            throw new InternalException(e);
    ...
    public static Channel createChannel(final Session session, final ChannelType channelType, final long timeout) {
        ...
        try {
            ...
            Logger.warn(
                    ...
                    "Extra",
                    e,
                    "JSch channel creation failed: channelType={}, timeoutMs={}, sessionConnected={}, exception={}",
                    channelType,
                    timeout,
                    session.isConnected(),
                    e.getClass().getSimpleName());
