...
public class Animation {
     ...
     *                  <ul>
     *                  <li>{@code 0} (default) indicates infinite looping, meaning the animation will replay
     *                  continuously.</li>
     *                  <li>Positive values denote finite repeat counts, allowing the animation to play a limited number
     *                  of times.</li>
     ...
     *                  </li>
     *                  <li>This background color provides a solid fill behind frames that have transparency, ensuring a
     *                  consistent display appearance.</li>
     *                  </ul>
     */
     ...
     *
     * <ul>
     * <li>{@code 0} (default) indicates infinite looping, meaning the animation will replay continuously.</li>
     * <li>Positive values denote finite repeat counts, allowing the animation to play a limited number of times.</li>
     * <li>If a negative value or a value beyond the maximum of {@code 0xffff} (65535) is provided, it is reset to
     * {@code 0} (infinite looping) to maintain valid bounds.</li>
     * </ul>
     *
     * <ul>
     * <li>Defaults to {@code Scalar()}, indicating an empty color (usually transparent if supported).</li>
     * <li>This background color provides a solid fill behind frames that have transparency, ensuring a consistent
     * display appearance.</li>
     * </ul>
     */
    public Animation() {
    ...
    // C++: cv::Animation::Animation(int loopCount = 0, Scalar bgColor = Scalar())
    private static native long Animation_0(
            int loopCount,
            double bgColor_val0,
            double bgColor_val1,
            double bgColor_val2,
