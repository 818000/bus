...
/**
 * Storage service provider for Baidu Object Storage (BOS). This provider integrates with Baidu BOS using an
...
public class BaiduBosProvider extends AbstractProvider {
    ...
    /**
     * Constructs a Baidu BOS provider with the given context. Initializes the S3 client and presigner using the
    ...
    /**
     * Reads metadata for an exact BOS object key.
     *
     * @param bucket    The bucket name.
     * @param objectKey The exact BOS object key.
     * @return A {@link Message} containing storage metadata.
     */
    @Override
    ...
    /**
     * Opens a stream for an exact BOS object key.
     *
     * @param bucket    The bucket name.
     * @param objectKey The exact BOS object key.
     * @return A {@link Message} containing a storage resource.
    ...
    /**
     * Releases BOS client resources held by this provider.
     */
    @Override
    public void close() {
