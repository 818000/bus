/*
 ...
 ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~
*/
package org.miaixz.bus.pay.nimble.wechat;
...
import org.miaixz.bus.pay.nimble.unionpay.api.UnionPayApi;
import org.miaixz.bus.pay.nimble.wechat.api.v2.*;
...
public class WechatPayProvider extends AbstractProvider<Voucher, Context> {
    ...
    public Message v3(
        ...
        if (null != params && !params.keySet().isEmpty()) {
            suffix = suffix.concat(Symbol.QUESTION_MARK).concat(Builder.createLinkString(params, true));
        }
        return v3(
                method,
                prefix,
    ...
    public Message xPay(Complex apiEnum, String appKey, String accessToken, String postBody) {
        ...
        String needSignMsg = url.concat(Symbol.AND).concat(postBody);
