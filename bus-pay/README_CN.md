...
第三方支付平台。它抽象化了单个支付网关 SDK 的复杂性，使支付变得简单 集成“如此简单！”对于开发人员来说。

该库支持主流支付网关包括 **Alipay**、 **微信支付**、 **银联**、 **PayPal**、 **QQ Pay** 和 **JD Pay**
，使您能够以最少的代码更改集成所有主要支付方式。
