/*
 ...
 ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~
*/
package org.miaixz.bus.notify.nimble.wechat;
...
public class WechatKfProvider extends AbstractProvider<WechatNotice, Context> {
    ...
    /**
     * Constructs a {@code WechatKfProvider} with the given context.
     *
    ...
    /**
     * Sends a WeChat Customer Service message. Implementations should override this method to provide specific sending
     * logic.
     *
    ...
    public Message<Void> send(WechatNotice entity) {
        Logger.warn(
                false,
                "Notify",
                "WeChat KF notify send rejected: template={}, targetPresent={}, reason=notImplemented",
