...
@Setter
@SuperBuilder
public class NeteaseNotice extends Notice {

    /**
     * Creates a NetEase Cloud SMS notice.
     */
    public NeteaseNotice() {
     ...
     *
     * @return The default API request address for NetEase Cloud SMS.
     */
    @Override
