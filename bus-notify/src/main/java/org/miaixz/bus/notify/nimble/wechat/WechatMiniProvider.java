 ...
 * @since Java 21+
 */
public class WechatMiniProvider extends AbstractProvider<WechatNotice, Context> {
    ...
    public Message<Void> send(WechatNotice entity) {
        Logger.warn(
                false,
                "Notify",
                "WeChat Mini notify send rejected: template={}, targetPresent={}, reason=notImplemented",
