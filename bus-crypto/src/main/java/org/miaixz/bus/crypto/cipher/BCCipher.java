...
public class BCCipher implements Cipher, Wrapper<Object> {
     ...
     * @throws org.miaixz.bus.core.lang.exception.CryptoException if this wrapper does not contain an AEAD cipher
     */
    @Override
    public void updateAad(final byte[] aad) {
        Assert.notNull(aad, "Additional authenticated data must not be null");
        if (aeadBlockCipher == null) {
            throw new org.miaixz.bus.core.lang.exception.CryptoException(
                    "Additional authenticated data requires an AEAD cipher");
        }
