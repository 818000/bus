 ...
 * <p>
 * Profile is a space-scoped environment dimension rather than a child resource of app, and it inherits the shared
 * setting-domain base fields from {@link org.miaixz.bus.cortex.Setting}. The canonical relationships are
 * {@code space -> profile} and {@code space -> app -> item}. Both app and item may bind to multiple
 * {@code profile_ids}.
 */
