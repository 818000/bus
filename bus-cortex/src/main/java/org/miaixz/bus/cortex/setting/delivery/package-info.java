 ...
 * {@code ItemExportService} exports resolved values for space/group/profile scopes while enforcing exposure policies so
 * that only public entries leave the control plane. {@code RuntimeItemOverlayService} provides a separate
