...
*/
/**
 * MCP (Model Context Protocol) definition registry and optional local process management.
 * <p>
 ...
 * {@code McpProcessManager} manages local stdio-hosted MCP servers: it starts commands with inherited I/O, stops them
