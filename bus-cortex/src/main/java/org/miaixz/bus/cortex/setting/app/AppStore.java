...
/**
 * Durable store contract for {@code setting.app} directory entries.
 *
 * @author Kimi Liu
 * @since Java 21+
 */
public interface AppStore {
    ...
    /**
     * Saves one application directory entry.
     *
    ...
    /**
     * Saves a batch of application entries.
     *
     * @param entries application entries
     * @return stored snapshots
     */
    default List<App> saveAll(List<App> entries) {
