...
public class StartupReporterProcessor implements BeanPostProcessor {
    ...
    /**
     * Bean names already injected by this Context-local processor.
     */
    private final Set<String> injectedBeanNames = ConcurrentHashMap.newKeySet();
    ...
    public Object postProcessBeforeInitialization(Object bean, String beanName) throws BeansException {
        if (bean instanceof StartupReporterAware aware && injectedBeanNames.add(beanName)) {
            aware.setStartupReporter(startupReporter);
        }
        return bean;
    }
