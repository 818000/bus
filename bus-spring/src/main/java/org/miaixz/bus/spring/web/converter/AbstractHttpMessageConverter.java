 ...
 * <p>
 * This class encapsulates the common rules for handling annotations such as {@link Include}, as well as Java's
 * {@code transient} keyword and null/empty values. It is designed to be used by concrete converter implementations for
 * libraries like Fastjson, GSON, and Jackson to ensure consistent behavior.
 * </p>
 *
 * @author Kimi Liu
 * @since Java 21+
...
public abstract class AbstractHttpMessageConverter implements MessageConverterRegistrar {
    ...
    /**
     * Initializes the shared type-filtering support used by concrete HTTP message converter registrars.
     */
     ...
     * rules.</li>
     * <li>If a field has the {@code transient} modifier, it is <strong>always skipped</strong>.</li>
    ...
    protected static boolean isFieldIgnored(Field field) {
        ...
        // Rule 2: the 'transient' keyword forces exclusion.
