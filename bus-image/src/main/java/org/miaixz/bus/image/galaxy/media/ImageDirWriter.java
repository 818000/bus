...
public class ImageDirWriter extends ImageDirReader {
     ...
     */
    private final byte[] dirInfoHeader = { 0x04, 0x00, 0x00, 0x12, 'U', Symbol.C_L, 4, 0, 0, 0, 0, 0, 0x04, 0x00, 0x02, 0x12,
            'U', Symbol.C_L, 4, 0, 0, 0, 0, 0, 0x04, 0x00, 0x12, 0x12, 'U', 'S', 2, 0, 0, 0, 0x04, 0x00, 0x20, 0x12, 'S', 'Q',
            0, 0, 0, 0, 0, 0 };

    /**
     * Byte array representing the header for Directory Records.
     */
    private final byte[] dirRecordHeader = { 0x04, 0x00, 0x00, 0x14, 'U', Symbol.C_L, 4, 0, 0, 0, 0, 0, 0x04, 0x00, 0x10, 0x14,
            'U', 'S', 2, 0, 0, 0, 0x04, 0x00, 0x20, 0x14, 'U', Symbol.C_L, 4, 0, 0, 0, 0, 0 };
