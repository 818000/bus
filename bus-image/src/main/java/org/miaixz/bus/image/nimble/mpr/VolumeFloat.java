...
public final class VolumeFloat extends Volume<Float> {
     ...
     */
    public VolumeFloat(int sizeX, int sizeY, int sizeZ, int channels) {
     ...
     * @param channels the channels.
     */
    public VolumeFloat(VolumeSize size, int channels) {
        super(size, true, channels);
        checkSingleChannel();
        this.data = new float[(int) elementCount()];
    }
     ...
     */
    @Override
    public Float getLinearValue(long index) {
     ...
     */
    @Override
    public void setLinearValue(long index, Float value) {
