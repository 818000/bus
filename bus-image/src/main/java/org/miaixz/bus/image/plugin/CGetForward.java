...
public class CGetForward implements AutoCloseable {
        ...
        protected void store(Association as, PresentationContext pc, Attributes rq, PDVInputStream data, Attributes rsp)
            ...
            try {
                ...
                try {
                    ...
                    Logger.error(false, "Image", "component=tool, Error when forwarding to the final destination", e);
                    Builder.notifyProgession(
                            streamSCU.getState(),
                            rq.getString(Tag.AffectedSOPInstanceUID),
                            rq.getString(Tag.AffectedSOPClassUID),
    ...
    private static Status process(
        ...
        try {
            ...
            try {
                ...
                Logger.error(false, "Image", "component=tool, getscu", e);
    ...
    private static void configureRelatedSOPClass(CGetForward getSCU, URL url) {
        ...
        try {
            ...
            Logger.error(false, "Image", "component=tool, Cannot read sop-classes", e);
        }
                ...
                if (p != null) {
                    ...
                    if (p.isCancel()) {
                        try {
                            ...
                            Logger.error(false, "Image", "component=tool, Cancel C-GET", e);
                        }
                    }
                }
            }
