...
public class NativeImageReader extends ImageReader implements Closeable {
    ...
    public static SOFSegment getSOFSegment(ImageInputStream iis) throws IOException {
        ...
        try {
            ...
            do {
                ...
                // SOF55 (0xF7) marks a JPEG-LS file; 0xC0..0xCF are JPEG SOF markers except DHT/JPG/DAC.
    ...
    /**
     * Determines whether the marker is a JPEG Start-Of-Frame marker.
     *
     * @param marker the marker
     * @return true if the marker is a JPEG Start-Of-Frame marker
     */
