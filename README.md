...
|---------|--------|-------------------------------------------------------------------------------------|-------------------------------------------------------------------------|
| 5.x     | java 8 | [org.aoju/bus-all/5.x](https://central.sonatype.com/artifact/org.aoju/bus-all/5.9.9)   | Compiled with java 8                                                    |
| 6.x     | java 17 | [org.aoju/bus-all/6.x](https://central.sonatype.com/artifact/org.aoju/bus-all/6.6.1) | Compiled with java 17, uses Jakarta EE, compatible with java 11, 17     |
| 8.x     | java 21 | [org.miaixz/bus-all/8.x](https://central.sonatype.com/artifact/org.miaixz/bus-alll) | Compiled with java 21, uses Jakarta EE, compatible with java 11, 17, 21 |
