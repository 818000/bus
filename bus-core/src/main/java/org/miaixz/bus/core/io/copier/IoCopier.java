...
/**
 * Abstract IO copier that supports buffer sizing, transfer observation, and flush behavior. This object is not
 * thread-safe.
 *
...
public abstract class IoCopier<S, T> {
    ...
    /**
     * Constructs an {@code IoCopier} with the specified buffer size, total count, and transfer observer.
     *
     ...
     */
    public IoCopier(final int bufferSize, final long count, final TransferObserver transferObserver) {
