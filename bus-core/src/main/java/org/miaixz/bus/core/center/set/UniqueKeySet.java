 ...
 * {@link FunctionX}. Unlike a standard {@link HashSet} which relies on {@link Object#equals(Object)} and
...
public class UniqueKeySet<K, V> extends AbstractSet<V> implements Serializable {
     ...
     */
    private final FunctionX<V, K> uniqueGenerator;
     ...
     */
    public UniqueKeySet(final FunctionX<V, K> uniqueGenerator) {
     ...
     */
    public UniqueKeySet(final FunctionX<V, K> uniqueGenerator, final Collection<? extends V> c) {
     ...
     * @param uniqueGenerator The function to generate a unique key for each element. Must not be {@code null}.
     */
    public UniqueKeySet(final boolean isLinked, final FunctionX<V, K> uniqueGenerator) {
     ...
     * @param uniqueGenerator The function to generate a unique key for each element. Must not be {@code null}.
     */
    public UniqueKeySet(final int initialCapacity, final float loadFactor, final FunctionX<V, K> uniqueGenerator) {
     ...
     * @param uniqueGenerator The function to generate a unique key for each element. Must not be {@code null}.
     */
    public UniqueKeySet(final MapBuilder<K, V> builder, final FunctionX<V, K> uniqueGenerator) {
