...
public final class ChannelSource implements Source {
    ...
    /**
     * Creates a channel backed source.
     *
     * @param channel the source channel
     * @param timeout the timeout information
     */
    public ChannelSource(ReadableByteChannel channel, Timeout timeout) {
        if (channel == null) {
    ...
    /**
     * Reads bytes from the channel into {@code sink}.
     *
    ...
    public long read(Buffer sink, long byteCount) throws IOException {
        ...
        java.nio.ByteBuffer target = java.nio.ByteBuffer.wrap(tail.data, tail.limit, maxToCopy);
    ...
    public String toString() {
        return "source(" + channel + Symbol.PARENTHESE_RIGHT;
    }
