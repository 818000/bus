...
public final class WebSocketCall extends MonoCall<WebSocketSession> {
    ...
    /**
     * Creates an unsubmitted WebSocket-open call.
     *
    ...
    /**
     * Claims the call's single submission path and opens the WebSocket session synchronously.
     *
     ...
     *
     * @return result returned by the WebSocket-open function
     */
    @Override
