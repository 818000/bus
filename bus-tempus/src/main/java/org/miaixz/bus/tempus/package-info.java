 ...
 * <ul>
 * <li>{@link org.miaixz.bus.tempus.Scheduler} The central scheduler for managing task lifecycles (add, remove, start,
 * stop).</li>
 * <li>{@link org.miaixz.bus.tempus.crontab.Crontab} An interface for defining the tasks to be executed.</li>
 * <li>{@link org.miaixz.bus.tempus.pattern.CronPattern} Represents a cron expression for defining task trigger
 * times.</li>
 * </ul>
 * <p>
