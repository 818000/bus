...
public interface ActivityOptionsFactory {
    ...
    /**
     * Creates activity options for the specified activity name.
     *
     * @param activityName the logical activity name (typically the activity interface simple name)
     * @return the activity options, or {@code null} to use framework defaults
     */
    ActivityOptions createActivityOptions(String activityName);
