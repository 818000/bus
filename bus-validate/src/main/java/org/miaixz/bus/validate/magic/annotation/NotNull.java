...
import org.miaixz.bus.validate.nimble.NotNullMatcher;

/**
 * Validates that the annotated object is not null.
 *
 * @author Kimi Liu
 * @since Java 21+
 */
...
public @interface NotNull {
     ...
     */
    String errcode() default ErrorCode._NOT_NULL;
     ...
     */
    String errmsg() default ErrorCode._NOT_NULL_VALUE;
