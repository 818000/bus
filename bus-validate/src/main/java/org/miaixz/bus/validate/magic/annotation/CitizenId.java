...
import org.miaixz.bus.validate.nimble.CitizenIdMatcher;
...
@Complex(value = Builder._CITIZENID, clazz = CitizenIdMatcher.class)
public @interface CitizenId {
     ...
     */
    String errcode() default ErrorCode._CITIZEN_ID;
     ...
     */
    String errmsg() default ErrorCode._CITIZEN_ID_VALUE;
