...
import org.miaixz.bus.validate.nimble.IntRangeMatcher;
...
@Complex(value = Builder._INT_RANGE, clazz = IntRangeMatcher.class)
public @interface IntRange {
     ...
     */
    String errcode() default ErrorCode._INT_RANGE;
     ...
     */
    String errmsg() default ErrorCode._INT_RANGE_VALUE;
