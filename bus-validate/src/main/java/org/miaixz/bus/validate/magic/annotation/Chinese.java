...
import org.miaixz.bus.validate.nimble.ChineseMatcher;
...
@Complex(value = Builder._CHINESE, clazz = ChineseMatcher.class)
public @interface Chinese {
     ...
     */
    String errcode() default ErrorCode._CHINESE;
     ...
     */
    String errmsg() default ErrorCode._CHINESE_VALUE;
