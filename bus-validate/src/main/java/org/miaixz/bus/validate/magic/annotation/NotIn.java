...
@Complex(value = Builder._NOT_IN, clazz = NotInMatcher.class)
public @interface NotIn {

    /**
     * The array of strings that the annotated element must not be one of.
     *
     * @return the array of forbidden strings.
     */
    @Filler("value")
     ...
     */
    String errcode() default ErrorCode._NOT_IN;
     ...
     */
    String errmsg() default ErrorCode._NOT_IN_VALUE;
