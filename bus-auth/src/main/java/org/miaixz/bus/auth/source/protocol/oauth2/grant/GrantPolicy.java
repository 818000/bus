 ...
 * <p>
 * authorization-server options implement this contract so grant mechanisms do not depend on endpoint or server
 * orchestration packages. It contains no endpoint addresses, client-authentication policy, persistence, or project
 * configuration.
 * </p>
 *
 * @author Kimi Liu
