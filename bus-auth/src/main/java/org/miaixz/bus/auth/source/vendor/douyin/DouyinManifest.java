 ...
 * @author Kimi Liu
 */
public class DouyinManifest implements VendorManifest<DouyinOptions> {
    ...
    public Scheme.Metadata metadata() {
        return new Scheme.Metadata("Douyin", "Douyin open-platform and mini-program login", "douyin");
    }
