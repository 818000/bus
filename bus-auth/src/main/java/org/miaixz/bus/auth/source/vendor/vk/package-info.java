 ...
 * </p>
 * <p>
 * This exported package provides Source configuration metadata; execution enters a configured Source through
 * Dispatcher. Only the non-blank private profile {@code user.user_id} becomes Identity subject and must equal token
 * {@code user_id} when present. Secrets, state, PKCE verifier, device ID, codes, tokens, profile bodies, and platform
 * errors must not enter diagnostics, Context, tracing, logs, or public failures.
 * </p>
 *
 * @author Kimi Liu
 */
