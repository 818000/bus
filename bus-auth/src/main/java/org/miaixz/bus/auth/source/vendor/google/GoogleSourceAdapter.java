...
public class GoogleSourceAdapter implements VendorAdapter {
    ...
    public GoogleSourceAdapter(final String spaceId, final String sourceId, final GoogleManifest manifest,
        ...
        if (!requiredAlgorithms.contains(JwaAlgorithm.RS256.name())) {
            throw new ValidateException("Google RS256 is not permitted by the OIDC security rules");
        }
    ...
    private Outcome<OpenIdProviderMetadata> metadata(final OpenIdProviderMetadata metadata) {
        try {
            ...
            return rejected("Google discovery metadata does not match the configured Source");
        }
    }
    ...
    private String idTokenIssuer(final JwsService.Jws parsed) {
        ...
        try {
            ...
            final JsonValue value = JsonKit.readValue(payload, Normal._16, true);
