 ...
 * </p>
 * <p>
 * SCIM services call this package at the HTTP boundary. Codecs consume the injected JsonProvider and typed JsonValue,
 * standard HTTP values, and SCIM models. They do not access persistence, authorize callers, apply mutations, resolve
 * credentials, invoke Registry, create identities, interpret Vendor data, use global JsonKit selection, or introduce a
 * framework request, response, page, or error envelope.
 * </p>
 * <p>
