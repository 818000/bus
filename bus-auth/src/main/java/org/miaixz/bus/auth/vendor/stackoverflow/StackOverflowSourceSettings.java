 ...
 * @param scopes      ordered requested Stack Overflow scopes, or empty to use the definition default
 ...
 * @author Kimi Liu
 */
public record StackOverflowSourceSettings(Vendor.Id vendor, Vendor.Variant variant, String clientId,
     ...
     *                                  invalid
     */
    public StackOverflowSourceSettings {
        if (!StackOverflowDefinition.ID.equals(vendor) || !StackOverflowDefinition.DEFAULT.equals(variant)) {
            throw new ValidateException("Stack Overflow settings must select stackoverflow/default");
        }
        ...
        if (redirectUri.isEmpty()) {
            throw new ValidateException("Stack Overflow settings require a registered redirect URI");
        }
    ...
    public String toString() {
        return "StackOverflowSourceSettings[vendor=" + vendor + ", variant=" + variant
