 ...
 * @author Kimi Liu
 */
public class AlipayManifest implements VendorManifest<AlipayOptions> {
    ...
    private static final VendorManifest.Variant VARIANT = new VendorManifest.Variant(ID, DEFAULT, Protocol.HTTPS,
            VendorManifest.Pkce.DISABLED, Credential.Type.PRIVATE_KEY, List.of("auth_user"),
            new VendorTargets(
     ...
     *
     * @param variant exact Alipay variant whose form is requested
    ...
    public Scheme.Metadata metadata() {
        return new Scheme.Metadata("Alipay", "Alipay public application identity authorization", "alipay");
    }
