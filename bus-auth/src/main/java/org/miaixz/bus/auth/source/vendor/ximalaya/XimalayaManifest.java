 ...
 * @author Kimi Liu
 */
public class XimalayaManifest implements VendorManifest<XimalayaOptions> {
     ...
     *
     * @param variant exact Ximalaya variant whose form is requested
    ...
    public Scheme.Form form(final Vendor.Variant variant) {
        ...
        return VendorManifest.Forms.extended(
                selected,
                List.of(
                        VendorManifest.Forms.field("deviceId", "Device identifier", Scheme.Form.Type.TEXT, true),
                        VendorManifest.Forms
                                .field("clientOsType", "Client operating-system type", Scheme.Form.Type.TEXT, true),
                        VendorManifest.Forms.field("packageId", "Package identifier", Scheme.Form.Type.TEXT, true)));
    }
    ...
    public Scheme.Metadata metadata() {
        return new Scheme.Metadata("Ximalaya", "Ximalaya account authorization", "ximalaya");
    }
