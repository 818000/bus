 ...
 * @author Kimi Liu
 */
public record RadiusProviderSettings(Set<RadiusPacket.Version> versions, boolean eapSupported,
        boolean requireMessageAuthenticator, int maximumPacketBytes) implements ProviderSettings {
    ...
    /**
     * Validates and freezes the RADIUS Provider settings.
     *
