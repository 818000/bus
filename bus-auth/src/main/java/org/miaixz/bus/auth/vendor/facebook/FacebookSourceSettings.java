 ...
 * <p>
 * Graph API v26.0 endpoints and app-secret-proof behavior remain definition-owned. This record retains only the public
 ...
 * @param scopes      ordered requested permissions, or empty to use definition defaults
 * @author Kimi Liu
 */
public record FacebookSourceSettings(Vendor.Id vendor, Vendor.Variant variant, String clientId,
     ...
     *                                  coverage differs from the frozen definition
     */
    public FacebookSourceSettings {
        if (!FacebookDefinition.ID.equals(vendor) || !FacebookDefinition.DEFAULT.equals(variant)) {
            throw new ValidateException("Facebook settings must select facebook/default");
        }
        ...
        if (redirectUri.isEmpty()) {
            throw new ValidateException("Facebook Login settings require a registered redirect URI");
        }
    ...
    public String toString() {
        return "FacebookSourceSettings[vendor=" + vendor + ", variant=" + variant
