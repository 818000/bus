 ...
 * </p>
 * <p>
 * {@code github/enterprise} is a separate HTTPS Variant using a referenced administrator token. It exposes the shared
 * root Realm DESCRIBE, SNAPSHOT, and RETRIEVE capabilities for visible enterprise and organization resources normalized
 * as ORGANIZATION, Teams normalized as GROUP, users, and membership. Coverage is PARTIAL, permission-hidden 404
 * responses are rejections rather than an empty complete snapshot, the fixed REST API version is always sent, and no
 * changes capability exists.
 * </p>
 * <p>
