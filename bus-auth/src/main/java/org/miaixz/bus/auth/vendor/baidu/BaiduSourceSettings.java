...
/**
 * Carries externally managed Baidu OAuth client registration values.
 * <p>
 * Fixed Baidu endpoints remain definition-owned. This record stores only public registration values and an external
 ...
 * @author Kimi Liu
 */
public record BaiduSourceSettings(Vendor.Id vendor, Vendor.Variant variant, String clientId,
     ...
     *                                  frozen definition
     */
    public BaiduSourceSettings {
        if (!BaiduDefinition.ID.equals(vendor) || !BaiduDefinition.DEFAULT.equals(variant)) {
            throw new ValidateException("Baidu settings must select baidu/default");
        }
        ...
        if (redirectUri.isEmpty()) {
            throw new ValidateException("Baidu browser settings require a registered redirect URI");
        }
    ...
    public String toString() {
        return "BaiduSourceSettings[vendor=" + vendor + ", variant=" + variant
