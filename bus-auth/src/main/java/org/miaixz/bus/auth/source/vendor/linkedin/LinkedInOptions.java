...
/**
 * Carries externally managed LinkedIn OpenID Connect client configuration values.
 * <p>
...
public record LinkedInOptions(Vendor.Id vendor, Vendor.Variant variant, String clientId,
    ...
    public String toString() {
        return "LinkedInOptions[vendor=" + vendor + Builder.VARIANT + variant + Builder.REDACTED_SOURCE_OPTIONS + scopes
