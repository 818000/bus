...
public record GoogleOptions(Vendor.Id vendor, Vendor.Variant variant, String clientId, Credential.Reference credential,
    ...
    /**
     * Preserves source compatibility for the historical six-component Google login constructor.
     *
     * @param vendor      exact Google platform identifier
     * @param variant     exact default Google login Variant
     * @param clientId    registered OAuth Client ID
     * @param credential  external Client Secret reference
     * @param redirectUri exact authorized callback
     * @param scopes      exact ordered OIDC scopes
     */
    public GoogleOptions(final Vendor.Id vendor, final Vendor.Variant variant, final String clientId,
