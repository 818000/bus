 ...
 * are scoped to this definition and never enter protocol metadata or Source sign-in flows.
 * </p>
 *
 * @author Kimi Liu
 */
public final class RedNoteDefinition implements VendorDefinition<RedNoteSourceSettings> {
    ...
    /**
     * Complete immutable RedNote marketing definition.
     */
    private static final VendorDefinition.Definition DEFINITION = new VendorDefinition.Definition(ID, MARKETING,
    ...
    /**
     * Creates the stateless RedNote definition used by Vendor directory assembly.
     */
    public RedNoteDefinition() {
     ...
     *
     * @return RedNote Source settings class
     */
    @Override
    public Class<RedNoteSourceSettings> settingsType() {
        return RedNoteSourceSettings.class;
    }
    ...
    /**
     * Resolves the exact marketing definition.
     *
     * @param variant requested RedNote variant
     * @return immutable marketing definition
     ...
     * @param scopes      ordered official marketing scopes, or empty to use definition defaults
