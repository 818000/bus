...
/**
 * Describes the standards-based OAuth 2.x authorization server Provider profile.
 *
 * @author Kimi Liu
 */
public final class OAuth2ProviderProfile implements ProviderProfile<OAuth2ProviderSettings> {
    ...
    public static final Capability<Void, AuthorizationServerMetadata> AUTHORIZATION_SERVER_METADATA = capability(
            ...
            Capability.Security.PUBLIC);
    /**
     * Exact OAuth 2.x server operations implemented by this profile.
     */
    ...
    /**
     * Management form containing protocol settings but no Store or runtime dependencies.
     */
    ...
    /**
     * Creates the stateless OAuth 2.0 provider profile used to compile authorization-server registrations.
     */
    public OAuth2ProviderProfile() {
     ...
     *
     * @param key      registered or platform settings key
    ...
    /**
     * Returns the stable OAuth 2.x Provider profile identifier.
     *
     * @return {@value #ID}
     */
    @Override
    ...
    /**
     * Returns the immutable Provider settings class.
     *
     * @return OAuth 2.x Provider settings class
     */
    @Override
    public Class<OAuth2ProviderSettings> settingsType() {
        return OAuth2ProviderSettings.class;
    }
     ...
     *
     * @return OAuth 2.x Provider settings form
     */
    @Override
    public Form form() {
        return FORM;
     ...
     */
    @Override
    public Optional<OAuth2ProviderSettings> defaults() {
