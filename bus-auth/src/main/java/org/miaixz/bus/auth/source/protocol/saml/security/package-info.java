 ...
 * consumes typed SAML documents, explicit trust material, resolvers, atomic replay storage, Policies, Context, and
 * Timeout. It does not parse arbitrary XML, fetch untrusted keys, infer trust from KeyInfo, implement transport, issue
 * assertions, persist project state, invoke Roster, or contain Vendor-specific signing rules.
 * </p>
 * <p>
