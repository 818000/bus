...
public enum WeiboScope implements AuthorizeScope {
     ...
     */
    WeiboScope(final String scope, final String description, final boolean isDefault) {
        this.scope = scope;
    ...
    /**
     * Returns the immutable Weibo wire scope.
     *
    ...
    /**
     * Reports whether the scope is selected when registration scopes are empty.
     *
