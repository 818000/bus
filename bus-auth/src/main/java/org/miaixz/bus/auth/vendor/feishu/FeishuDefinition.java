...
/**
 * Declares the frozen Feishu v3 OAuth browser Vendor definition.
 * <p>
 ...
 * @author Kimi Liu
 */
public final class FeishuDefinition implements VendorDefinition<FeishuSourceSettings> {
    ...
    /**
     * Creates the stateless Feishu definition used by Vendor directory assembly.
     */
    public FeishuDefinition() {
     ...
     *
     * @return Feishu Source settings class
     */
    @Override
    public Class<FeishuSourceSettings> settingsType() {
        return FeishuSourceSettings.class;
    }
    ...
    /**
     * Returns the exact default Feishu definition.
     *
