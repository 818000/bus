 ...
 * Identity is created only when the profile envelope contains exactly one registered user with a positive integral
 * {@code user_id}; that ID alone is the subject. Secrets, state, codes, access tokens, Stack Apps key, site, profile
 * bodies, and errors must not enter diagnostics, Context, tracing, logs, or public failures.
 * </p>
 *
 * @author Kimi Liu
 */
