...
import org.miaixz.bus.auth.source.protocol.scim.ErrorResponse;
 ...
 * <p>
 * The codec never serializes Bus errors, exceptions, stack traces, Roster values, or internal Outcome objects.
 * </p>
 *
 * @author Kimi Liu
 */
public class ScimErrorCodec {
     ...
     */
    public ScimErrorCodec(final long maximumBytes, final int maximumDepth) {
     ...
     *
     * @param object implementation-neutral Error JSON object
