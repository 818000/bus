 ...
 * <p>
 * The record retains only public configuration values, an external secret reference, and the optional S256 selector.
...
public record AmazonOptions(Vendor.Id vendor, Vendor.Variant variant, String clientId, Credential.Reference credential,
    ...
    public String toString() {
        return "AmazonOptions[vendor=" + vendor + Builder.VARIANT + variant + Builder.REDACTED_SOURCE_OPTIONS + scopes
                + ", pkce=" + pkce + Symbol.BRACKET_RIGHT;
    }
