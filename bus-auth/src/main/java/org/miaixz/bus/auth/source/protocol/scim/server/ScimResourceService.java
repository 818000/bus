...
public class ScimResourceService {
    ...
    /**
     * Typed SCIM Service Provider options and discovery associations.
     */
    ...
    /**
     * Creates a resource service for one compiled SCIM Service Provider.
     *
     * @param sourceId compiled server-role Source identifier
     * @param options  typed SCIM Service Provider options
     * @param store    externally supplied data port
     */
    public ScimResourceService(final String sourceId, final ScimServerOptions options, final ScimResourceStore store) {
    ...
    public CompletionStage<Outcome<Resource>> create(
        ...
        try {
            return resourceResult(store.create(sourceId, resource, context, timeout), type);
    ...
    public CompletionStage<Outcome<Resource>> retrieve(
        ...
        try {
            return resourceResult(store.retrieve(sourceId, target, context, timeout), target.resourceType().name());
        } catch (RuntimeException failure) {
    ...
    public CompletionStage<Outcome<Resource>> replace(
        ...
        try {
            return resourceResult(store.replace(sourceId, target, resource, ifMatch, context, timeout), type);
        } catch (RuntimeException failure) {
    ...
    public CompletionStage<Outcome<Resource>> patch(
        ...
        try {
            return resourceResult(
                    store.patch(sourceId, request, context, timeout),
    ...
    public CompletionStage<Outcome<Void>> delete(
        ...
        try {
            final CompletionStage<Outcome<Void>> stage = store.delete(sourceId, target, ifMatch, context, timeout);
    ...
    public CompletionStage<Outcome<ListResponse>> search(
        ...
        try {
            final CompletionStage<Outcome<Result<Resource>>> stage = store.search(sourceId, request, context, timeout);
