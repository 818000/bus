 ...
 * @author Kimi Liu
 */
public class PinterestManifest implements VendorManifest<PinterestOptions> {
    ...
    private static final VendorManifest.Variant VARIANT = new VendorManifest.Variant(ID, DEFAULT, Protocol.OAUTH2,
            VendorManifest.Pkce.DISABLED, Credential.Type.CLIENT_SECRET, List.of("read_public"),
            new VendorTargets(
                    Optional.of(
    ...
    /**
     * Creates the stateless Pinterest manifest used by Vendor module assembly.
     */
    ...
    public Scheme.Metadata metadata() {
        return new Scheme.Metadata("Pinterest", "Pinterest account authorization", "pinterest");
    }
