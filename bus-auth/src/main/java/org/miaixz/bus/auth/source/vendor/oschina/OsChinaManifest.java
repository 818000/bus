 ...
 * @author Kimi Liu
 */
public class OsChinaManifest implements VendorManifest<OsChinaOptions> {
    ...
    /**
     * Creates the stateless OSChina manifest used by Vendor module assembly.
     */
    ...
    public Scheme.Metadata metadata() {
        return new Scheme.Metadata("OSChina", "OSChina account authorization", "oschina");
    }
