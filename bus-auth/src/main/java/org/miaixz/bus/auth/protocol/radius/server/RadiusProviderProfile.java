...
/**
 * Declares the RADIUS Access and Accounting server Provider profile implemented by the Provider driver.
 * <p>
 ...
 * @author Kimi Liu
 */
public final class RadiusProviderProfile implements ProviderProfile<RadiusProviderSettings> {
    ...
    /**
     * External management form corresponding exactly to RadiusProviderSettings.
     */
    ...
    /**
     * Creates the stateless RADIUS Provider profile.
     */
    public RadiusProviderProfile() {
     ...
     *
     * @return RADIUS Provider settings type
     */
    @Override
    public Class<RadiusProviderSettings> settingsType() {
        return RadiusProviderSettings.class;
    }
     ...
     *
     * @return immutable RADIUS settings form
     */
    @Override
    public Form form() {
        return FORM;
     ...
     */
    @Override
    public Optional<RadiusProviderSettings> defaults() {
