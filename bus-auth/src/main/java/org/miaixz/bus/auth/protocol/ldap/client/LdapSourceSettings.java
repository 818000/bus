...
/**
 * Holds immutable deployment settings for one LDAPv3 directory Source.
 * <p>
 ...
 * input and never become settings. The Source driver additionally constrains the message limit against the shared LDAP
 * security baseline.
 * </p>
 *
 ...
 * @author Kimi Liu
 */
public record LdapSourceSettings(String host, int port, SecurityMode securityMode, DistinguishedName searchBase,
        ...
        int maximumBerDepth) implements SourceSettings {
    ...
    public String toString() {
        return "LdapSourceSettings[host=" + host + ", port=" + port + ", securityMode=" + securityMode + ", searchBase="
