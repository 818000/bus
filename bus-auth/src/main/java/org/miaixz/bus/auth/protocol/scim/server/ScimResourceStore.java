...
public interface ScimResourceStore {
     ...
     */
    CompletionStage<Outcome<Resource>> create(
            String providerId,
            Resource resource,
            Context context,
     ...
     */
    CompletionStage<Outcome<Resource>> patch(
            String providerId,
     ...
     */
    CompletionStage<Outcome<ListResponse>> resourceTypes(String providerId, Context context, Timeout.Budget timeout);
     ...
     */
    CompletionStage<Outcome<ListResponse>> schemas(String providerId, Context context, Timeout.Budget timeout);
