...
import org.miaixz.bus.auth.source.protocol.scim.PatchOp;
import org.miaixz.bus.auth.source.protocol.scim.PatchOperation;
...
public class ScimPatchCodec {
     ...
     */
    public ScimPatchCodec(final long maximumBytes, final int maximumDepth) {
