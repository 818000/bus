 ...
 * @author Kimi Liu
 */
public interface AuthorizationCodeStore extends AtomicStore<String, ExpiringValue<AuthorizationCodeStore.Entry>> {
     ...
     * @author Kimi Liu
     */
    record Entry(String providerId, String clientId, String subjectId, String redirectUri, boolean redirectUriRequired,
            List<String> scope, List<String> resource, Optional<String> codeChallenge,
     ...
     * @author Kimi Liu
     */
    record OpenIdBinding(Optional<String> nonce, Instant authenticatedAt, Optional<String> authenticationContextClass,
            List<String> authenticationMethods, Session.Key sessionKey,
