...
/**
 * Declares the frozen Meituan Waimai OAuth 2.0 Vendor definition.
 * <p>
 ...
 * @author Kimi Liu
 */
public final class MeituanDefinition implements VendorDefinition<MeituanSourceSettings> {
    ...
    /**
     * Complete immutable Meituan endpoint, client, capability, form, and deviation definition.
     */
    ...
    /**
     * Creates the stateless Meituan definition used by Vendor directory assembly.
     */
    public MeituanDefinition() {
    ...
    /**
     * Returns the exact Meituan external settings type.
     *
     * @return Meituan settings class
     */
    @Override
    public Class<MeituanSourceSettings> settingsType() {
        return MeituanSourceSettings.class;
    }

    /**
     * Returns the immutable single Meituan variant definition.
     *
