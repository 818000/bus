...
public final class VkSourceAdapter implements VendorAdapter {
     ...
     */
    public VkSourceAdapter(final String namespaceId, final String sourceId, final VkManifest manifest,
            final VariantManifest.Variant variant, final VkOptions options, final ExecutionServices services) {
