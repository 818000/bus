...
/**
 * Declares the Toutiao OAuth 2.0 browser Vendor definition.
 * <p>
 ...
 * @author Kimi Liu
 */
public final class ToutiaoDefinition implements VendorDefinition<ToutiaoSourceSettings> {
    ...
    /**
     * Complete immutable Toutiao endpoint, client, capability, form, and deviation definition.
     */
    ...
    /**
     * Creates the stateless Toutiao definition used by Vendor directory assembly.
     */
    public ToutiaoDefinition() {
     ...
     *
     * @return Toutiao Source settings class
     */
    @Override
    public Class<ToutiaoSourceSettings> settingsType() {
        return ToutiaoSourceSettings.class;
    }
    ...
    /**
     * Resolves the exact default Toutiao definition.
     *
