 ...
 * serialization. Client decoding is bounded, implementation-neutral, and closes the owned response without selecting an
...
public class JwkSetCodec {
    ...
    /**
     * Creates a strict JWK Set resource codec that processes JSON through {@link JsonKit}.
     */
    public JwkSetCodec() {
    }
    ...
    public Response encodeResponse(final Request request, final JwkSet jwkSet) {
        ...
        final byte[] body = JsonKit.writeValue(publication.toJson());
