...
public class AuthenticationRequestEncoder {
    ...
    /**
     * Creates an OIDC Authentication Request encoder that serializes claims through {@link JsonKit}.
     */
    ...
    /**
     * Serializes a claims request as compact implementation-neutral UTF-8 JSON.
     *
     * @param claims claims request object
     * @return JSON text
     */
    private String json(final JsonValue.ObjectValue claims) {
        return new String(JsonKit.writeValue(claims), Charset.UTF_8);
    }
