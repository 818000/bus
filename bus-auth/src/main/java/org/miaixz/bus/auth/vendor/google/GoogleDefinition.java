...
/**
 * Declares the frozen Google OpenID Connect Vendor definition.
 *
 * @author Kimi Liu
 */
public final class GoogleDefinition implements VendorDefinition<GoogleSourceSettings> {
    ...
    /**
     * Creates the stateless Google definition used by Vendor directory assembly.
     */
    public GoogleDefinition() {
     ...
     *
     * @return Google Source settings class
     */
    @Override
    public Class<GoogleSourceSettings> settingsType() {
        return GoogleSourceSettings.class;
    }
     ...
     * @return exact default Google definition
