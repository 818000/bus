...
/**
 * Declares the frozen LINE Login OpenID Connect Vendor definition.
 * <p>
 ...
 * @author Kimi Liu
 */
public final class LineDefinition implements VendorDefinition<LineSourceSettings> {
    ...
    /**
     * Complete immutable LINE web endpoint, client, scope, capability, form, and deviation definition.
     */
    private static final VendorDefinition.Definition DEFINITION = new VendorDefinition.Definition(ID, DEFAULT,
            Protocol.OIDC, List.of("profile", "openid"),
            new VendorTargets(
                    Optional.of(
                            fixed(
    ...
    /**
     * Creates the stateless LINE definition used by Vendor directory assembly.
     */
    ...
    /**
     * Returns the exact LINE external settings type.
     *
     * @return LINE settings class
     */
    @Override
    public Class<LineSourceSettings> settingsType() {
        return LineSourceSettings.class;
    }

    /**
     * Returns the immutable single LINE variant definition.
     *
