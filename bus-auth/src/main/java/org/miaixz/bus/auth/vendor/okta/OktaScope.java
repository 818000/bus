...
public enum OktaScope implements AuthorizeScope {
     ...
     */
    OktaScope(String scope, String description, boolean isDefault) {
        this.scope = scope;
    ...
    /**
     * Returns the immutable Okta wire value sent in an authorization request.
     *
    ...
    /**
     * Returns the immutable human-readable grant description.
     *
    ...
    /**
     * Indicates whether the scope is selected when a registration supplies no explicit scopes.
     *
     * @return {@code true} for the six standard OpenID Connect scopes; otherwise {@code false}
     */
    @Override
