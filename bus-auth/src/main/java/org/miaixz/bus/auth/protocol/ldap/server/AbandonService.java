...
public class AbandonService {
     ...
     */
    public AbandonService(final String providerId, final LdapServerOptions options, final DirectoryStore store) {
        this.providerId = Assert.notBlank(providerId, "LDAP Abandon Provider id must not be blank");
        this.options = Assert.notNull(options, "LDAP Abandon Provider options must not be null");
