 ...
 * @author Kimi Liu
 */
public class SamlClientScheme implements ProtocolScheme<SamlClientOptions> {

    /**
     * Stable Source type identifier for generic SAML Sources.
     */
    ...
    /**
     * Creates the stateless SAML service-server scheme used to compile Source configurations.
     */
    ...
    /**
     * Returns management presentation metadata for a SAML service-provider Source.
     *
     * @return immutable SAML client metadata
     */
    @Override
    public Metadata metadata() {
        return new Metadata("SAML Service Provider", "Connects to a standards-based SAML identity provider.", "saml");
    }
