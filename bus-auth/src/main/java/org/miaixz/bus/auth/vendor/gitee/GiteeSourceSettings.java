 ...
 * <p>
 * Fixed Gitee.com endpoints and the prohibition on PKCE remain definition-owned. This record retains only the public
 ...
 * @author Kimi Liu
 */
public record GiteeSourceSettings(Vendor.Id vendor, Vendor.Variant variant, String clientId,
     ...
     */
    /**
     * Minimum identity scope required by the frozen Gitee login definition.
     */
     ...
     */
    public GiteeSourceSettings {
        if (!GiteeDefinition.ID.equals(vendor) || !GiteeDefinition.DEFAULT.equals(variant)) {
            throw new ValidateException("Gitee settings must select gitee/default");
        }
        ...
        if (redirectUri.isEmpty()) {
            throw new ValidateException("Gitee settings require a registered redirect URI");
        }
    ...
    public String toString() {
        return "GiteeSourceSettings[vendor=" + vendor + ", variant=" + variant
