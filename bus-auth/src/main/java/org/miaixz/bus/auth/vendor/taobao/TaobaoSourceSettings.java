 ...
 * @author Kimi Liu
 */
public record TaobaoSourceSettings(Vendor.Id vendor, Vendor.Variant variant, String clientId,
     ...
     */
    public TaobaoSourceSettings {
        if (!TaobaoDefinition.ID.equals(vendor) || !TaobaoDefinition.DEFAULT.equals(variant)) {
            throw new ValidateException("Taobao settings must select taobao/default");
        }
        ...
        if (redirectUri.isEmpty()) {
            throw new ValidateException("Taobao settings require a registered redirect URI");
        }
    ...
    public String toString() {
        return "TaobaoSourceSettings[vendor=" + vendor + ", variant=" + variant
