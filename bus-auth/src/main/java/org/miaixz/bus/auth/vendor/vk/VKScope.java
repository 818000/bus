...
public enum VKScope implements AuthorizeScope {
     ...
     */
    VKScope(String scope, String description, boolean isDefault) {
        this.scope = scope;
    ...
    /**
     * Returns the immutable VK wire scope.
     *
    ...
    /**
     * Reports whether the scope is selected when registration scopes are absent.
     *
     * @return default-selection flag
     */
    @Override
