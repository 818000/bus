...
public class AppleManifest implements VendorManifest<AppleOptions> {
    ...
    private static final VendorManifest.Variant VARIANT = new VendorManifest.Variant(ID, DEFAULT, Protocol.OIDC,
            VendorManifest.Pkce.DISABLED, Credential.Type.PRIVATE_KEY, List.of("name", "email"),
     ...
     *
     * @param variant exact Apple variant whose form is requested
    ...
    public Scheme.Metadata metadata() {
        return new Scheme.Metadata("Apple", "Sign in with Apple OpenID Connect", "apple");
    }
