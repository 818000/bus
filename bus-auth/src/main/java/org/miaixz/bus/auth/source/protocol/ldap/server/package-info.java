...
*/
/**
 * Implements the LDAP version 3 directory-server direction.
 * <p>
 ...
 * </p>
 * <p>
 * Services consume typed LDAP messages, authenticated connection Context, Policies, codecs, and DirectoryStore. The
 * framework owns protocol validation and response sequencing; the external project owns directory persistence,
 * credential verification, authorization, schema data, and deployment configuration. This package has no Controller,
 * Source/client behavior, JNDI backend, Vendor integration, direct Roster lookup, or HTTP/JSON response abstraction.
 * </p>
 * <p>
