...
/**
 * Declares the frozen Xiaomi OAuth 2.0 browser Vendor definition.
 * <p>
 ...
 * @author Kimi Liu
 */
public final class MiDefinition implements VendorDefinition<MiSourceSettings> {
    ...
    /**
     * Creates the stateless Xiaomi definition used by Vendor directory assembly.
     */
    public MiDefinition() {
    ...
    /**
     * Returns the exact externally decoded Xiaomi settings record.
     *
     * @return Xiaomi Source settings class
     */
    @Override
    public Class<MiSourceSettings> settingsType() {
        return MiSourceSettings.class;
    }
    ...
    /**
     * Returns the exact default Xiaomi definition.
     *
