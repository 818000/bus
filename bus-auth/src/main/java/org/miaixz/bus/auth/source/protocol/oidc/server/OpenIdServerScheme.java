 ...
 * @author Kimi Liu
 */
public class OpenIdServerScheme implements ProtocolScheme<OpenIdServerOptions> {
    ...
    private static final Capability.Manifest MANIFEST = new Capability.Manifest(List.of(
            AUTHENTICATION,
            OAuth2ServerScheme.TOKEN,
            OAuth2ServerScheme.INTROSPECTION,
            OAuth2ServerScheme.REVOCATION,
            OAuth2ServerScheme.DEVICE_AUTHORIZATION,
            OAuth2ServerScheme.AUTHORIZATION_SERVER_METADATA,
            DISCOVERY,
            JWK_SET,
            USERINFO,
            END_SESSION));
    ...
    /**
     * Creates the stateless OpenID server scheme used to compile server Source configurations.
     */
    ...
    /**
     * Creates one OpenID Provider direction capability.
     *
    ...
    /**
     * Returns management presentation metadata for an OpenID Provider.
     *
     * @return immutable OpenID Connect server metadata
     */
    @Override
    public Metadata metadata() {
        return new Metadata("OpenID Connect Server", "Exposes standards-based OpenID Provider endpoints.", "openid");
    }

    /**
     * Returns the OpenID Provider category.
     *
     * @return OpenID Provider type
     */
    @Override
    ...
    /**
     * Returns the external OpenID Provider management form.
     *
