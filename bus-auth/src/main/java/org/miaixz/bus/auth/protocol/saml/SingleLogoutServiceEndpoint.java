...
/**
 * Models a SAML Metadata {@code SingleLogoutService} endpoint.
 *
 ...
 * @author Kimi Liu
 */
public record SingleLogoutServiceEndpoint(SamlBinding binding, String location, Optional<String> responseLocation,
     ...
     */
    public SingleLogoutServiceEndpoint {
        Assert.notNull(binding, "SAML SingleLogoutService Binding must not be null");
        absolute(location, "SAML SingleLogoutService Location");
        responseLocation = optionalUri(responseLocation, "SAML SingleLogoutService ResponseLocation");
        extensions = elements(extensions, "SAML SingleLogoutService extension");
        attributes = attributes(attributes, "SAML SingleLogoutService");
    }
    ...
    public List<byte[]> extensions() {
        return elements(extensions, "SAML SingleLogoutService extension");
    }
