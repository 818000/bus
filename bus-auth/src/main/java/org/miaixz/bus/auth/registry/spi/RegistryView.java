...
/**
 * Exposes one internally immutable and revision-consistent Registry view.
 * <p>
 * This module-internal SPI supports Registry routing and safe Library lookup. It is not exported to business callers;
 * only {@code Registry.invoke} may execute a returned runtime provider.
 * </p>
 *
 * @author Kimi Liu
 */
public interface RegistryView {
    ...
    /**
     * Looks up one internal runtime provider by its kind-safe Registry reference.
     *
     * @param reference Source Registry reference
     * @return runtime provider when the enabled record compiled in this revision
     */
    Optional<RuntimeProvider> runtime(Registry.Reference reference);
