...
/**
 * Holds immutable deployment and security settings for one SAML 2.0 service-provider Source.
 * <p>
 ...
 * external key resolver for each signing operation.
 * </p>
 *
 ...
 * @author Kimi Liu
 */
public record SamlSourceSettings(String entityId, String identityProviderEntityId,
        ...
        boolean wantResponsesSigned, Duration clockSkew, Duration maximumAssertionAge) implements SourceSettings {
     ...
     * @throws ValidateException        if a URI, endpoint, binding, or time limit violates the SAML Source profile
     */
    public SamlSourceSettings {
     ...
     *
     * @return redacted SAML Source settings summary
     */
    @Override
    public String toString() {
        return "SamlSourceSettings[entityId=" + entityId + ", identityProviderEntityId=" + identityProviderEntityId
