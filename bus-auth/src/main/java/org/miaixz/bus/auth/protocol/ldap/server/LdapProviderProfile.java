...
/**
 * Declares the standards-based LDAPv3 directory server Provider profile.
 * <p>
 ...
 * @author Kimi Liu
 */
public final class LdapProviderProfile implements ProviderProfile<LdapProviderSettings> {
    ...
    /**
     * Creates the stateless LDAP provider profile used to validate and compile server registrations.
     */
    public LdapProviderProfile() {
    ...
    /**
     * Returns the exact immutable LDAP Provider settings class.
     *
     * @return LDAP Provider settings type
     */
    @Override
    public Class<LdapProviderSettings> settingsType() {
        return LdapProviderSettings.class;
    }
    ...
    /**
     * Returns the external management form for LDAP Provider settings.
     *
     ...
     */
    @Override
    public Optional<LdapProviderSettings> defaults() {
