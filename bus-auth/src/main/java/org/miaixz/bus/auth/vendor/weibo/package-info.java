 ...
 * </p>
 * <p>
 * This exported package is registration metadata; execution enters a Registry-obtained Provider. Profile {@code id} and
 * optional {@code idstr} must bind to the token {@code uid}, and only that verified UID becomes subject. Secrets,
 * state, codes, access tokens, UID, profile bodies, and errors must not enter diagnostics, Context, tracing, logs, or
 * public failures.
 * </p>
 *
 * @author Kimi Liu
