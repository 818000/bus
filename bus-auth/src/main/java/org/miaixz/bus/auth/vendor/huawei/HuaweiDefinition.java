...
/**
 * Declares the frozen Huawei Account Kit OpenID Connect Vendor definition.
 * <p>
 * The definition separates standard OpenID Connect request and response models from Huawei's documented form-post,
 ...
 * @author Kimi Liu
 */
public final class HuaweiDefinition implements VendorDefinition<HuaweiSourceSettings> {
    ...
    /**
     * External management fields required for one Huawei web client registration.
     */
    /**
     * Complete immutable definition for Huawei's default web Authorization Code Flow.
     */
    ...
    /**
     * Creates the stateless Huawei definition used by Vendor directory assembly.
     */
    ...
    /**
     * Creates one external management field without embedding registration values.
     *
     * @param key      exact settings key
     * @param label    management label
     * @param type     input representation
     * @param required whether the field is mandatory
     * @return immutable field definition
     */
    /**
    ...
    /**
     * Returns the exact external settings record accepted by this definition.
     *
     * @return Huawei settings class
     */
    @Override
    public Class<HuaweiSourceSettings> settingsType() {
        return HuaweiSourceSettings.class;
    }

    /**
     * Returns the immutable single Huawei variant definition.
     *
