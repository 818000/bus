...
/**
 * Declares the immutable JD OAuth 2.0 Vendor definition and its Zeus profile-operation deviations.
 * <p>
 ...
 * @author Kimi Liu
 */
public final class JdDefinition implements VendorDefinition<JdSourceSettings> {
    ...
    /**
     * Exact Registry-visible operations supported by JD login.
     */
    ...
    /**
     * Complete immutable endpoint, scope, capability, and deviation definition.
     */
    private static final VendorDefinition.Definition DEFINITION = new VendorDefinition.Definition(ID, DEFAULT,
            Protocol.OAUTH2, List.of("snsapi_base"),
    ...
    /**
     * Creates the stateless JD definition used by Vendor directory assembly.
     */
    public JdDefinition() {
    ...
    public Vendor.Metadata metadata() {
        return new Vendor.Metadata("JD", "JD account authorization", "jd");
    }

    /**
     * Returns the exact JD external settings type.
     *
     * @return JD settings class
     */
    @Override
    public Class<JdSourceSettings> settingsType() {
        return JdSourceSettings.class;
    }

    /**
     * Returns the immutable single JD variant definition.
     *
