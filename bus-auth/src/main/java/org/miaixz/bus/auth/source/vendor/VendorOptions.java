 ...
 * {@link VendorManifest}; adapter construction belongs to {@link VendorBinding}. Options do not decode persistence,
...
public interface VendorOptions<O extends VendorOptions<O>> extends Options<O> {
     ...
     *
     * @return platform identifier used to select one {@link VendorManifest}
     */
    Vendor.Id vendor();
     ...
     *
     * @return variant identifier used to select one {@link VendorManifest.Variant}
     */
     ...
     * <p>
     * The selected {@link VendorManifest.Variant} remains the only authority for whether PKCE is disabled, optional, or
     * required. This value cannot enable a disabled variant or disable a required variant.
     * </p>
     *
