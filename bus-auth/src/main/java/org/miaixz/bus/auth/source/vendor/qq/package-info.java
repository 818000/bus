 ...
 * </p>
 * <p>
 * This exported package exposes Source configuration metadata; runtime execution must enter a configured Source through
 * Dispatcher. Open identity uses bound OpenID or the requested available UnionID, while Mini Program identity always
 * uses OpenID. Credentials, state, codes, access and refresh tokens, session keys, callback bodies, JSONP, and profile
 * documents must not enter diagnostics, Context, tracing, logs, or public failure details.
 * </p>
 *
 * @author Kimi Liu
 */
