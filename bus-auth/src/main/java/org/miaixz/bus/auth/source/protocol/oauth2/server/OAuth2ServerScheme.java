...
/**
 * Describes the standards-based OAuth 2.x authorization-server scheme.
 *
 * @author Kimi Liu
 */
public class OAuth2ServerScheme implements ProtocolScheme<OAuth2ServerOptions> {
    ...
    /**
     * Creates the stateless OAuth 2.0 server scheme used to compile authorization-server Source configurations.
     */
    ...
    /**
     * Creates one authorization server-direction OAuth 2.x capability.
     *
    ...
    /**
     * Returns management presentation metadata for an OAuth 2.x authorization server.
     *
     * @return immutable OAuth server metadata
     */
    @Override
    public Metadata metadata() {
        return new Metadata("OAuth 2.x Server", "Exposes standards-based OAuth authorization and token endpoints.",
                "oauth2");
    }
     ...
     *
     * @return OAuth 2.x authorization server type
     */
    @Override
    ...
    /**
     * Returns the immutable authorization-server management form.
     *
     * @return OAuth 2.x authorization server options form
     */
    @Override
    public Form form() {
        return FORM;
