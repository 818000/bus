...
public enum ProginnScope implements AuthorizeScope {
     ...
     */
    ProginnScope(String scope, String description, boolean isDefault) {
        this.scope = scope;
    ...
    /**
     * Returns the immutable Proginn wire value sent in an authorization request.
     *
     ...
     *
     * @return {@code true} only for basic profile access
     */
    @Override
