...
/**
 * Declares the frozen Gitee OAuth browser Vendor definition.
 * <p>
 ...
 * @author Kimi Liu
 */
public final class GiteeDefinition implements VendorDefinition<GiteeSourceSettings> {
    ...
    /**
     * Creates the stateless Gitee definition used by Vendor directory assembly.
     */
    public GiteeDefinition() {
     ...
     *
     * @return Gitee Source settings class
     */
    @Override
    public Class<GiteeSourceSettings> settingsType() {
        return GiteeSourceSettings.class;
    }
    ...
    /**
     * Returns the exact default Gitee definition.
     *
