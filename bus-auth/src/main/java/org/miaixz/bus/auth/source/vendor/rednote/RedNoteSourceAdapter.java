...
import org.miaixz.bus.auth.source.vendor.rednote.RedNoteManifest.MarketingAuthorizationRequest;
import org.miaixz.bus.auth.source.vendor.rednote.RedNoteManifest.MarketingTokenRequest;
import org.miaixz.bus.auth.source.vendor.rednote.RedNoteManifest.MarketingTokenResponse;
...
public class RedNoteSourceAdapter implements VendorAdapter {
    ...
    /**
     * Validated externally loaded marketing configuration options.
     */
     ...
     *
     * @param spaceId  Source space retained by the uniform adapter construction contract
     * @param sourceId Source identifier retained for Roster routing only
