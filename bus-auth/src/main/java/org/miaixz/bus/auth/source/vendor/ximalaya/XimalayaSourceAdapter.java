...
public class XimalayaSourceAdapter implements VendorAdapter {
    ...
    /**
     * Source identifier used in the resulting external identity.
     */
    ...
    public XimalayaSourceAdapter(final String spaceId, final String sourceId, final XimalayaManifest manifest,
            final VendorManifest.Variant variant, final XimalayaOptions options, final SourceServices services) {
    ...
    /**
     * Validates one public authorization request against the configured Source.
     *
     * @param request standard OAuth authorization request
     ...
     */
    private Outcome<Identity> profile(final Access access, final SecretLease secret, final Timeout timeout) {
        if (timeout.expired()) {
