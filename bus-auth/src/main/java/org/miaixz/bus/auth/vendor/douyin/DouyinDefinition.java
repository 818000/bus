 ...
 * @author Kimi Liu
 */
public final class DouyinDefinition implements VendorDefinition<DouyinSourceSettings> {
    ...
    /**
     * Complete immutable ordinary mini-program definition.
     */
    ...
    /**
     * Creates the stateless Douyin definition used by Vendor directory assembly.
     */
    public DouyinDefinition() {
    ...
    /**
     * Returns the exact settings record shared by both variants.
     *
     * @return Douyin settings class
     */
    @Override
    public Class<DouyinSourceSettings> settingsType() {
        return DouyinSourceSettings.class;
    }
    ...
    /**
     * Returns the unique selected variant definition.
     *
