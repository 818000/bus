 ...
 * SHARED_SECRET token. It exposes describe, snapshot, and retrieve through Groups, descendant Groups, direct/all
 * Members, and Users REST endpoints. Groups normalize as ORGANIZATION, membership carries the upstream access level,
 * coverage is PARTIAL, and no changes operation is declared.
 * </p>
 * <p>
