...
public record FigmaOptions(Vendor.Id vendor, Vendor.Variant variant, String clientId, Credential.Reference credential,
     ...
     */
    public FigmaOptions {
        if (!FigmaManifest.ID.equals(vendor) || !FigmaManifest.DEFAULT.equals(variant)) {
            throw new ValidateException("Figma options must select figma/default");
        }
    ...
    public String toString() {
        return "FigmaOptions[vendor=" + vendor + ", variant=" + variant
