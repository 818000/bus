 ...
 * <p>
 * {@link org.miaixz.bus.auth.source.protocol.saml.client.SamlServiceProvider} initiates Web Browser SSO and Single
 * Logout with HTTP-Redirect or HTTP-POST bindings. AssertionConsumerService decodes and validates the returned SAML
 * Response before producing a stable external identity, while MetadataClient obtains and validates Identity Provider
 * metadata. SamlClientScheme and SamlClientOptions declare the exact entity, endpoints, bindings, trust material, and
 ...
 * Policies, and Fabric transport. It does not host an Identity Provider, issue Assertions, persist project data, select
 * a Vendor, establish trust from unvalidated metadata, invoke Roster directly, or expose XML, keys, or framework
 * failures as an application identity.
 * </p>
 * <p>
