 ...
 * OAuth options. Discovery documents and JWK Sets are runtime data and are never stored in this configuration model.
 * </p>
 *
...
public record OpenIdClientOptions(OAuth2ClientOptions oauth2Options, Optional<Endpoint> discoveryEndpoint,
    ...
    /**
     * Returns this already immutable OpenID Connect client configuration snapshot.
     *
