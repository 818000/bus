 ...
 * <p>
 * LinkedIn endpoints, issuer compatibility, token behavior, and RS256 validation remain definition- and adapter-owned.
 ...
 * @author Kimi Liu
 */
public record LinkedInSourceSettings(Vendor.Id vendor, Vendor.Variant variant, String clientId,
     ...
     *                                  definition
     */
    public LinkedInSourceSettings {
        if (!LinkedInDefinition.ID.equals(vendor) || !LinkedInDefinition.DEFAULT.equals(variant)) {
            throw new ValidateException("LinkedIn settings must select linkedin/default");
        }
        ...
        if (redirectUri.isEmpty()) {
            throw new ValidateException("LinkedIn settings require a registered redirect URI");
        }
    ...
    public String toString() {
        return "LinkedInSourceSettings[vendor=" + vendor + ", variant=" + variant
