 ...
 * <p>
 * GiteeDefinition fixes {@code gitee/default}, its authorization, token, refresh, and current-user endpoints,
 ...
 * </p>
 * <p>
 * GiteeSourceSettings contains routing, client, secret-reference, exact HTTPS callback, and ordered unique scopes. It
 * cannot carry endpoints, passwords, PKCE values, User-Agent policy, private response records, token capabilities, or a
