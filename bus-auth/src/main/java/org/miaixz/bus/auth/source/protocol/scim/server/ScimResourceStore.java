...
public interface ScimResourceStore {
     ...
     */
    CompletionStage<Outcome<Resource>> create(String sourceId, Resource resource, Context context, Timeout timeout);
     ...
     */
    CompletionStage<Outcome<Resource>> patch(String sourceId, PatchRequest request, Context context, Timeout timeout);
     ...
     */
    CompletionStage<Outcome<BulkResponse>> bulk(String sourceId, BulkRequest request, Context context, Timeout timeout);

    /**
     * Loads ResourceType discovery resources for the current SCIM Service Provider Source.
     *
     * @param sourceId compiled server-role Source identifier
     * @param context  immutable invocation context
     * @param timeout  shared end-to-end timeout
     ...
     */
    CompletionStage<Outcome<ListResponse>> resourceTypes(String sourceId, Context context, Timeout timeout);

    /**
     * Loads Schema discovery resources for the current SCIM Service Provider Source.
     *
     * @param sourceId compiled server-role Source identifier
     * @param context  immutable invocation context
     * @param timeout  shared end-to-end timeout
     ...
     */
    CompletionStage<Outcome<ListResponse>> schemas(String sourceId, Context context, Timeout timeout);
