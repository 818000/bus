 ...
 * Dispatcher. Identity uses a verified {@code taobao_user_id}, falling back to {@code taobao_open_uid} only when the
 * former is absent; decoded nickname is an attribute. Secrets, state, codes, tokens, extension values, and bodies must
 * not enter diagnostics, Context, tracing, logs, or public failures.
 * </p>
 *
 * @author Kimi Liu
 */
