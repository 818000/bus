...
/**
 * Declares the standards-based SCIM 2.0 Service Provider profile.
 *
 * @author Kimi Liu
 */
public final class ScimProviderProfile implements ProviderProfile<ScimProviderSettings> {
    ...
    public static final Capability<Void, ListResponse> SCHEMAS = capability(
            ...
            ListResponse.class);
    /**
     * Complete potential profile manifest before settings-based compiler narrowing.
     */
    private static final Capability.Manifest MANIFEST = new Capability.Manifest(List.of(
            ...
            SCHEMAS));
    /**
     * Formal SCIM specifications implemented by this profile.
     */
    ...
    /**
     * External management form containing only SCIM deployment settings.
     */
    ...
    /**
     * Creates the stateless SCIM provider profile used to compile provisioning registrations.
     */
    public ScimProviderProfile() {
        // No initialization required.
    }

    /**
     * Creates one direct, client-authenticated Provider-direction SCIM capability.
     *
    ...
    private static <Q, S> Capability<Q, S> capability(
        ...
        return new Capability<>(key, requestType, responseType, Capability.Direction.PROVIDER,
    ...
    /**
     * Returns the stable SCIM Provider profile identifier.
     *
     * @return {@value #ID}
     */
    @Override
    ...
    /**
     * Returns the exact settings class decoded for this profile.
     *
     * @return SCIM Provider settings class
     */
    @Override
    public Class<ScimProviderSettings> settingsType() {
        return ScimProviderSettings.class;
    }
    ...
    /**
     * Returns the external management form for SCIM deployment settings.
     *
     * @return immutable SCIM Provider form
     */
    @Override
    public Form form() {
        return FORM;
     ...
     */
    @Override
    public Optional<ScimProviderSettings> defaults() {
