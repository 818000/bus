 ...
 * single transition to token consumption cannot race. Storage mechanics and atomicity are delegated to bus-cache; the
 * project-facing verification workflow remains outside this cache wrapper.
 * </p>
 *
 * @author Kimi Liu
 */
