 ...
 * Only a non-blank profile {@code _id} becomes Identity subject. Secrets, state, codes, access or refresh tokens,
 * authorization headers, profile bodies, and upstream errors must not enter diagnostics, Context, tracing, logs, or
 * public failures.
 * </p>
 *
 * @author Kimi Liu
