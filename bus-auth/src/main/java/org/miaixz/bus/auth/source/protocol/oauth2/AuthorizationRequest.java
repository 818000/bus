 ...
 * <p>
 * Registered parameters use typed components while unrecognized extension parameters remain in a implementation-neutral
 * JSON object for codec-controlled wire conversion. This model does not select an endpoint or execute a redirect.
 * </p>
 *
