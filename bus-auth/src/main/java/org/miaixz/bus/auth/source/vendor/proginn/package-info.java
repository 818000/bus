 ...
 * the private profile GET carrying {@code access_token} in the query is a configured Source-completion deviation.
 * </p>
 * <p>
 ...
 * </p>
 * <p>
 * This exported package provides Source configuration and Realm management metadata. Runtime invocation must enter a
 * Provider obtained from Roster and delegate to the non-exported adapter. Only the non-blank Proginn profile
 * {@code uid} becomes Identity subject; nickname, avatar, and email remain attributes. Client secrets, state, callback
