 ...
 * @author Kimi Liu
 */
public final class DingTalkDefinition implements VendorDefinition<DingTalkSourceSettings> {
     ...
     */
    private static final Capability.Manifest OAUTH2_MANIFEST = new Capability.Manifest(List.of(
     ...
     */
    private static final Capability.Manifest ACCOUNT_MANIFEST = new Capability.Manifest(List.of(
            SourceAuthentication.initiate(Set.of(Capability.Interaction.REDIRECT)),
            SourceAuthentication.complete(Set.of(Capability.Interaction.REDIRECT))));
    ...
    /**
     * Complete immutable delegated OAuth 2.0 variant definition.
     */
    private static final VendorDefinition.Definition OAUTH2_DEFINITION = new VendorDefinition.Definition(ID, OAUTH2,
            ...
            targets(
                    ...
                    fixed(
                            ...
                            Http.Method.POST,
                            CLIENT_SECRET_JSON)),
            OAUTH2_MANIFEST, OAUTH2_DEVIATIONS);

    /**
     * Complete immutable proprietary account-login variant definition.
     */
    private static final VendorDefinition.Definition ACCOUNT_DEFINITION = new VendorDefinition.Definition(ID, ACCOUNT,
            ...
            targets(
                    ...
                    fixed(
                            ...
                            Endpoint.Authentication.NONE),
                    null),
            ACCOUNT_MANIFEST, ACCOUNT_DEVIATIONS);

    /**
     * Creates the stateless DingTalk definition used by Vendor directory assembly.
     */
    public DingTalkDefinition() {
    ...
    private static VendorTargets targets(
        ...
        return new VendorTargets(Optional.of(authorization), Optional.empty(), Optional.ofNullable(token),
                Optional.of(userInfo), Optional.ofNullable(refresh), Optional.empty(), Optional.empty(),
    ...
    /**
     * Returns the exact immutable settings record accepted by both variants.
     *
     * @return DingTalk Source settings class
     */
    @Override
    public Class<DingTalkSourceSettings> settingsType() {
        return DingTalkSourceSettings.class;
    }

    /**
     * Returns both variants in stable management order.
     *
     * @return delegated OAuth 2.0 then account-login definitions
     */
    @Override
    public List<VendorDefinition.Definition> variants() {
        return List.of(OAUTH2_DEFINITION, ACCOUNT_DEFINITION);
    }

    /**
     * Returns the exact definition for one supported DingTalk variant.
     *
     * @param variant requested variant
     * @return exact immutable variant definition
