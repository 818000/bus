...
/**
 * Carries externally managed Huawei Account Kit web-client configuration values.
 * <p>
...
public record HuaweiOptions(Vendor.Id vendor, Vendor.Variant variant, String clientId, Credential.Reference credential,
    ...
    public String toString() {
        return "HuaweiOptions[vendor=" + vendor + Builder.VARIANT + variant + Builder.REDACTED_SOURCE_OPTIONS + scopes
