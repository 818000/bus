...
/**
 * Declares the frozen Alipay RSA2 gateway authentication Vendor definition.
 *
 * @author Kimi Liu
 */
public final class AlipayDefinition implements VendorDefinition<AlipaySourceSettings> {

    /**
     * Stable routing identifier used to select the Alipay Vendor definition.
     */
    ...
    private static final List<VendorDeviation> DEVIATIONS = List.of(
            ...
            deviation(
                    ...
                    true));
    /**
     * Complete immutable definition for the frozen Alipay public-application flow.
     */
    private static final VendorDefinition.Definition DEFINITION = new VendorDefinition.Definition(ID, DEFAULT,
            ...
            new VendorTargets(
                    ...
                    Optional.empty(), Optional.of(fixed("https://openapi.alipay.com/gateway.do", Http.Method.POST)),
    ...
    /**
     * Creates the stateless Alipay definition that exposes its immutable gateway definition.
     */
    public AlipayDefinition() {
    ...
    /**
     * Returns the only settings type accepted by this definition.
     *
     * @return exact Alipay settings class
     */
    @Override
    public Class<AlipaySourceSettings> settingsType() {
        return AlipaySourceSettings.class;
    }
    ...
    /**
     * Returns the exact Alipay definition.
     *
