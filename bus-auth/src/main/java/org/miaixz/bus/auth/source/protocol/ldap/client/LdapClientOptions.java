...
import org.miaixz.bus.auth.source.protocol.ldap.DistinguishedName;
import org.miaixz.bus.auth.source.protocol.ldap.SearchRequest;
...
public record LdapClientOptions(String host, int port, SecurityMode securityMode, DistinguishedName searchBase,
    ...
    /**
     * Returns this already immutable LDAP client configuration snapshot.
     *
