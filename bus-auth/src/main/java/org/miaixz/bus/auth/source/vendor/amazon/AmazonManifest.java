...
public class AmazonManifest implements VendorManifest<AmazonOptions> {
    ...
    private static final VendorManifest.Variant VARIANT = new VendorManifest.Variant(ID, DEFAULT, Protocol.OAUTH2,
            VendorManifest.Pkce.OPTIONAL, Credential.Type.CLIENT_SECRET,
    ...
    public Scheme.Metadata metadata() {
        return new Scheme.Metadata("Amazon", "Login with Amazon OAuth 2.0 sign-in", "amazon");
    }
     ...
     * @return exact Login with Amazon manifest
