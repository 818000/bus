 ...
 * <p>
 * Decoding retains the complete original XML bytes and the document-wide unique XML ID index. Signature validation
...
public class SamlMessageCodec {
    ...
    private static void typed(final Element element, final String type, final String text) {
        ...
        element.setAttributeNS(XMLConstants.W3C_XML_SCHEMA_INSTANCE_NS_URI, Saml.Xml.XSI_TYPE, type);
     ...
     * @return typed request with original document and unique ID index
     */
     ...
     *
     * @param xml raw UTF-8 XML bytes
     * @return typed response with original document and unique ID index
     */
     ...
     *
     * @param xml raw UTF-8 XML bytes
     * @return typed assertion with original document and unique ID index
     */
    ...
    /**
     * Encodes one implementation-neutral JSON scalar as a complete SAML AttributeValue element.
     * <p>
     ...
     * </p>
     *
     * @param value implementation-neutral scalar value
        ...
        switch (value) {
            ...
            case JsonValue.NullValue ignored -> {
                element.setAttributeNS(
                        ...
                        Saml.Xml.XMLNS_XSI,
                        XMLConstants.W3C_XML_SCHEMA_INSTANCE_NS_URI);
                element.setAttributeNS(XMLConstants.W3C_XML_SCHEMA_INSTANCE_NS_URI, Saml.Xml.XSI_NIL, Normal.TRUE);
            }
    ...
    /**
     * Retains one securely decoded typed SAML message with its exact original XML and unique ID index.
     *
    ...
    public record Document<T>(T message, byte[] xml, Set<String> ids) {
        ...
        /**
         * Takes immutable ownership of the original XML and identifier index.
         *
