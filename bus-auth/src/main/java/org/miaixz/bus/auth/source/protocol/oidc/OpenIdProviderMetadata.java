 ...
 * implemented Authorization Code Flow. OpenID Provider-side generation remains responsible for publishing only compiled
...
public record OpenIdProviderMetadata(AuthorizationServerMetadata authorizationServerMetadata,
     ...
     * @param required metadata value mandated by the applicable OpenID Connect profile
