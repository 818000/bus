 ...
 */
public record StreamConfiguration(Mode mode, URI endpoint, TransportPolicy policy, int maximumAttempts,
    ...
    public StreamConfiguration {
        ...
        endpoint = UriValidator.https(UriValidator.transport(endpoint, policy));
        Assert.isTrue(
