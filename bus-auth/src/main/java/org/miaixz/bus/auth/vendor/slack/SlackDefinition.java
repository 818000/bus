...
/**
 * Declares the Slack OAuth 2.0 browser Vendor definition.
 * <p>
 ...
 * @author Kimi Liu
 */
public final class SlackDefinition implements VendorDefinition<SlackSourceSettings> {
    ...
    /**
     * Complete immutable Slack endpoint, client, scope, capability, form, and deviation definition.
     */
    private static final VendorDefinition.Definition DEFINITION = new VendorDefinition.Definition(ID, DEFAULT,
            Protocol.OAUTH2, List.of("users.profile:read", "users:read", "users:read.email"),
    ...
    /**
     * Creates the stateless Slack definition used by Vendor directory assembly.
     */
    public SlackDefinition() {
     ...
     *
     * @return Slack Source settings class
     */
    @Override
    public Class<SlackSourceSettings> settingsType() {
        return SlackSourceSettings.class;
    }
    ...
    /**
     * Resolves the exact default Slack definition.
     *
