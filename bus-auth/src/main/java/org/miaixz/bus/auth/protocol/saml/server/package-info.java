...
*/
/**
 * Implements the SAML 2.0 Identity Provider and Provider direction.
 * <p>
 ...
 * claim ports, Assertion issuance, replay storage, SecurityBaseline, and Fabric transport. It does not implement user
 * authentication, project persistence, permissions, SP behavior, Vendor integration, direct Registry access, or a
