...
/**
 * Describes the generic standards-based OpenID Connect relying-party Source profile.
 *
 * @author Kimi Liu
 */
public final class OpenIdSourceProfile implements SourceProfile<OpenIdClientSettings> {
     ...
     */
    public static final Capability<TokenRequest, TokenEndpointResponse> TOKEN = OAuth2SourceProfile.TOKEN;
    /**
     * Executes standard OAuth token introspection when the Source declares an introspection endpoint.
     */
    public static final Capability<IntrospectionRequest, IntrospectionResponse> INTROSPECTION = OAuth2SourceProfile.INTROSPECTION;
    /**
     * Executes standard OAuth token revocation when the Source declares a revocation endpoint.
     */
    public static final Capability<RevocationRequest, Void> REVOCATION = OAuth2SourceProfile.REVOCATION;
    /**
     * Executes standard OAuth device authorization when the Source declares a device endpoint.
     */
    public static final Capability<DeviceAuthorizationRequest, DeviceAuthorizationResponse> DEVICE_AUTHORIZATION = OAuth2SourceProfile.DEVICE_AUTHORIZATION;
    /**
     * Retrieves RFC 8414 Authorization Server Metadata when the Source declares its endpoint.
     */
    public static final Capability<Void, AuthorizationServerMetadata> AUTHORIZATION_SERVER_METADATA = OAuth2SourceProfile.AUTHORIZATION_SERVER_METADATA;
    /**
    ...
    /**
     * Returns the stable generic OpenID Connect profile identifier.
     *
     * @return {@value #ID}
     */
    @Override
     ...
     *
     * @return OpenID Connect client settings class
     */
    @Override
    public Class<OpenIdClientSettings> settingsType() {
        return OpenIdClientSettings.class;
    }
     ...
     */
    @Override
    public Optional<OpenIdClientSettings> defaults() {
