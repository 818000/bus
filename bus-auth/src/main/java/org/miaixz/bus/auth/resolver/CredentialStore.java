 ...
 * <p>
 * This external port is distinct from {@link SecretResolver}: a resolver reads material referenced by persistent
 * settings, while this store owns material such as OAuth 1.0 temporary and token credential secrets created at runtime.
