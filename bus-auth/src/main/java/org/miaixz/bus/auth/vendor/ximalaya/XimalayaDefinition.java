...
/**
 * Declares the immutable Ximalaya OAuth 2.0 browser-login definition.
 * <p>
 ...
 * @author Kimi Liu
 */
public final class XimalayaDefinition implements VendorDefinition<XimalayaSourceSettings> {
    ...
    private static final List<VendorDeviation> DEVIATIONS = List.of(
            ...
            deviation(
                    ...
                    false));
    /**
     * Complete immutable Ximalaya endpoint, client, capability, form, and deviation definition.
     */
    ...
    /**
     * Creates the stateless Ximalaya definition used by Vendor directory assembly.
     */
    public XimalayaDefinition() {
     ...
     *
     * @return Ximalaya Source settings class
     */
    @Override
    public Class<XimalayaSourceSettings> settingsType() {
        return XimalayaSourceSettings.class;
    }

    /**
     * Returns the sole supported Ximalaya variant.
     *
     * @return immutable singleton definition list
     */
    @Override
    ...
    /**
     * Resolves the exact default Ximalaya definition.
     *
