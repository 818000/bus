...
import org.miaixz.bus.auth.protocol.oauth2.server.OAuth2ProviderProfile;
import org.miaixz.bus.auth.protocol.oidc.*;
import org.miaixz.bus.auth.provider.ProviderProfile;
...
/**
 * Describes the standards-based OpenID Connect Provider profile.
 *
 * @author Kimi Liu
 */
public final class OpenIdProviderProfile implements ProviderProfile<OpenIdProviderSettings> {
     ...
     */
    public static final Capability<AuthenticationRequest, AuthorizationResponse> AUTHENTICATION = capability(
     ...
     */
    public static final Capability<TokenRequest, TokenEndpointResponse> TOKEN = OAuth2ProviderProfile.TOKEN;
    /**
     * Introspects OAuth access-token state when the composed endpoint is configured.
     */
    public static final Capability<IntrospectionRequest, IntrospectionResponse> INTROSPECTION = OAuth2ProviderProfile.INTROSPECTION;
    /**
     * Revokes OAuth access or refresh token state when the composed endpoint is configured.
     */
    public static final Capability<RevocationRequest, Void> REVOCATION = OAuth2ProviderProfile.REVOCATION;
    /**
     * Issues OAuth device and user codes when the composed endpoint is configured.
     */
    public static final Capability<DeviceAuthorizationRequest, DeviceAuthorizationResponse> DEVICE_AUTHORIZATION = OAuth2ProviderProfile.DEVICE_AUTHORIZATION;
    /**
     * Publishes composed OAuth Authorization Server Metadata when configured.
     */
    public static final Capability<Void, AuthorizationServerMetadata> AUTHORIZATION_SERVER_METADATA = OAuth2ProviderProfile.AUTHORIZATION_SERVER_METADATA;
    /**
     ...
     */
    public static final Capability<EndSessionRequest, Void> END_SESSION = capability(
    ...
    /**
     * Creates the stateless OpenID Provider profile used to compile server registrations.
     */
    public OpenIdProviderProfile() {
    ...
    /**
     * Returns the stable OpenID Provider profile identifier.
     *
     * @return {@value #ID}
     */
    @Override
    ...
    /**
     * Returns the immutable settings class decoded for this profile.
     *
     * @return OpenID Provider settings class
     */
    @Override
    public Class<OpenIdProviderSettings> settingsType() {
        return OpenIdProviderSettings.class;
    }
     ...
     */
    @Override
    public Optional<OpenIdProviderSettings> defaults() {
