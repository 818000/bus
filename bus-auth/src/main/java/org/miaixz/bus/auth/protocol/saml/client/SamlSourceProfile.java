...
/**
 * Declares the generic SAML 2.0 service-provider Source profile.
 * <p>
 ...
 * @author Kimi Liu
 */
public final class SamlSourceProfile implements SourceProfile<SamlSourceSettings> {
    ...
    /**
     * Formal specifications implemented by this service-provider profile.
     */
    ...
    /**
     * External management form containing only deployment settings owned by a SAML Source.
     */
    ...
    /**
     * Creates the stateless SAML service-provider profile used to compile source registrations.
     */
    public SamlSourceProfile() {
    ...
    /**
     * Returns the stable generic SAML Source profile identifier.
     *
     * @return {@value #ID}
     */
    @Override
     ...
     *
     * @return SAML Source settings class
     */
    @Override
    public Class<SamlSourceSettings> settingsType() {
        return SamlSourceSettings.class;
    }
    ...
    /**
     * Returns the external management form for SAML service-provider settings.
     *
     ...
     */
    @Override
    public Optional<SamlSourceSettings> defaults() {
