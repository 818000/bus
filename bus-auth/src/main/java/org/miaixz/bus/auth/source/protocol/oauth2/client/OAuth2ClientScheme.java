...
/**
 * Describes the generic standards-based OAuth 2.x client scheme.
 *
 * @author Kimi Liu
 */
public class OAuth2ClientScheme implements ProtocolScheme<OAuth2ClientOptions> {
    ...
    /**
     * Returns management presentation metadata for a generic OAuth 2.x client Source.
     *
     * @return immutable OAuth client metadata
     */
    @Override
    public Metadata metadata() {
        return new Metadata("OAuth 2.x Client", "Connects to a standards-based OAuth authorization server.", "oauth2");
    }
