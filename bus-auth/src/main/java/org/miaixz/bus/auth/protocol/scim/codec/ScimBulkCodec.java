...
public final class ScimBulkCodec {
     ...
     */
    public ScimBulkCodec(final JsonProvider jsonProvider, final Function<String, ResourceType> resourceTypeResolver,
            final long maximumBytes, final int maximumDepth) {
        this.jsonProvider = Assert.notNull(jsonProvider, "SCIM Bulk JSON provider must not be null");
    ...
    /**
     * Creates the legacy typed resource reference required by the current PatchOp model.
     *
