...
*/
/**
 * Declares the Feishu confidential-client OAuth Source and optional Realm-capable Contact v3 variants.
 * <p>
 ...
 * Realm CHANGES implementation.
 * </p>
 * <p>
 * Realm invocation still enters the shared Dispatcher execution path. The package does not schedule sync jobs, persist
 * directory state, promise fields outside the allow-listed projection, or convert Contact events into durable change
 * cursors. Tenant tokens, application secrets, upstream documents, and personal values remain Source-private.
 * </p>
 *
 * @author Kimi Liu
 */
