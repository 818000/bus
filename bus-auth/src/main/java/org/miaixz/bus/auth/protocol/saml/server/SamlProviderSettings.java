...
/**
 * Holds immutable deployment and security settings for one SAML 2.0 identity Provider.
 * <p>
 ...
 * @author Kimi Liu
 */
public record SamlProviderSettings(String entityId, Endpoint singleSignOnServiceEndpoint,
        ...
        Duration clockSkew) implements ProviderSettings {
     ...
     *
     * @return redacted SAML Provider settings summary
     */
    @Override
    public String toString() {
        return "SamlProviderSettings[entityId=" + entityId + ", singleSignOnServiceEndpoint=[CONFIGURED]"
