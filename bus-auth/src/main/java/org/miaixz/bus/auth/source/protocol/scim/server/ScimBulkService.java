...
public class ScimBulkService {
    ...
    /**
     * Validated SCIM Service Provider options governing Bulk and resource policy.
     */
    ...
    /**
     * Creates a Bulk service for one exact compiled SCIM Service Provider.
     *
     ...
     */
    public ScimBulkService(final String sourceId, final ScimServerOptions options, final ScimResourceStore store) {
    ...
    public CompletionStage<Outcome<BulkResponse>> bulk(
        ...
        try {
            final CompletionStage<Outcome<BulkResponse>> stage = store.bulk(sourceId, request, context, timeout);
            if (stage == null) {
    ...
    /**
     * Validates one typed Bulk operation against SCIM Service Provider options and its registered resource target.
     *
