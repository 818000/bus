...
/**
 * Microsoft China third-party authentication client.
 *
 * <p>
...
public class MicrosoftCnProvider extends AbstractMicrosoftProvider {
    ...
    /**
     * Creates a Microsoft China client from explicit runtime dependencies.
     *
     * @param configuration non-null registration, Fabric, clock, state-store, cache, and secret dependencies
     */
    public MicrosoftCnProvider(final VendorConfiguration configuration) {
        super(configuration, BuiltinVendors.MICROSOFT_CN);
    }
