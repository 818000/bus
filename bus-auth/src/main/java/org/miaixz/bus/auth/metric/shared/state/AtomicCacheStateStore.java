...
public final class AtomicCacheStateStore implements StateStore {
     ...
     */
    public AtomicCacheStateStore(final CacheX<String, byte[]> cache) {
     ...
     */
    private static String cacheKey(final Invocation invocation, final String key) {
        final Invocation current = Objects.requireNonNull(invocation, "Invocation must not be null");
