...
public class RuntimeServices {
    ...
    /**
     * Runtime-scoped facade providing every Fabric service visible to bus-auth.
     */
    ...
    /**
     * {@return the shared authentication Fabric facade}
     */
    FabricX fabric() {
        return fabric;
    }
    ...
    DriverServices scope(
        ...
        final Blueprint.SourceEntry source = Assert
