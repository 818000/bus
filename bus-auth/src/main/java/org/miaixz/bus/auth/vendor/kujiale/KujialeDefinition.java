...
/**
 * Declares the immutable Kujiale OAuth 2.0 Vendor definition and its private account-resolution wire contract.
 * <p>
 ...
 * @author Kimi Liu
 */
public final class KujialeDefinition implements VendorDefinition<KujialeSourceSettings> {
    ...
    /**
     * Creates the stateless Kujiale definition used by Vendor directory assembly.
     */
    public KujialeDefinition() {
    ...
    public Vendor.Metadata metadata() {
        return new Vendor.Metadata("Kujiale", "Kujiale account authorization", "kujiale");
    }

    /**
     * Returns the exact Kujiale external settings type.
     *
     * @return Kujiale settings class
     */
    @Override
    public Class<KujialeSourceSettings> settingsType() {
        return KujialeSourceSettings.class;
    }

    /**
     * Returns the immutable single Kujiale variant definition.
     *
