...
public class UserInfoCodec {
    ...
    /**
     * Creates a strict UserInfo codec.
     *
     ...
     */
    public UserInfoCodec(final JsonProvider jsonProvider) {
        this.jsonProvider = Assert.notNull(jsonProvider, "OpenID Connect UserInfo JSON provider must not be null");
    }
    ...
    /**
     * Decodes one provider-neutral UserInfo Claims object into the typed standard response model.
     *
