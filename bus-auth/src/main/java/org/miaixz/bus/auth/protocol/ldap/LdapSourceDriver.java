...
import org.miaixz.bus.auth.protocol.ldap.client.LdapClientScheme;
import org.miaixz.bus.auth.protocol.ldap.client.LdapIdentityParser;
 ...
 * @author Kimi Liu
 */
public final class LdapSourceDriver implements SourceDriver<LdapClientOptions> {
    ...
    /**
     * Validates typed options, enforces the LDAP baseline, and assembles one direct-authentication runtime.
     *
    ...
    public SourceWorker compile(
        ...
        final LdapClientOptions options = require(source.getOptions());
        ...
        return new CompiledSource(source.getId(), options, services, frameCodec, encoder, decoder, identity);
    }
    ...
    private static final class CompiledSource implements SourceWorker {
        ...
        /**
         * External Fabric, executor, loaders, parsers, and baseline dependencies.
         */
         ...
         */
        private CompiledSource(final String sourceId, final LdapClientOptions options, final ExecutionServices services,
