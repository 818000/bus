 ...
 * @author Kimi Liu
 */
public final class StateEnvelopeCodec implements WireCodec<byte[], byte[]> {

    /**
     * Shared stateless state-envelope codec.
     */
    public static final StateEnvelopeCodec INSTANCE = new StateEnvelopeCodec();
     ...
     */
    @Override
    public byte[] encode(final byte[] payload) {
     ...
     */
    @Override
    public byte[] decode(final byte[] envelope) {
