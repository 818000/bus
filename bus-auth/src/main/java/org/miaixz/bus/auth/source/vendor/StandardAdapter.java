...
public class StandardAdapter implements VendorAdapter {
     ...
     */
    public StandardAdapter(final VendorManifest.Variant variant, final VendorOptions<?> options,
     ...
     * @param timeout    effective deadline for the delegated capability invocation
