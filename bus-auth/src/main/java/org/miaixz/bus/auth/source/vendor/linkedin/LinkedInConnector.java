...
/**
 * Connects the complete LinkedIn platform manifest and its exact variant factories.
 *
 * @author Kimi Liu
 */
public class LinkedInConnector implements VendorConnector {

    /**
     * Creates a stateless LinkedIn SPI connector.
     */
    ...
    /**
     * Returns the stable LinkedIn platform key.
     *
     * @return stable LinkedIn platform key
     */
    @Override
    public Vendor.Id key() {
        return LinkedInManifest.ID;
    }

    /**
     * Binds the LinkedIn manifest, Options factory, and all adapter factories as one registration.
     *
    ...
    public void connect(final VendorRegistry registry) {
        Assert.notNull(registry, "Vendor registry must not be null").bind(
                ...
                VendorRegistry.options(LinkedInOptions::new),
                List.of(
                        VendorRegistry.adapter(
                                LinkedInManifest.class,
                                LinkedInSourceAdapter::new,
