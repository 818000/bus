...
/**
 * Declares the OSChina OAuth 2.0 browser Vendor definition.
 * <p>
 ...
 * @author Kimi Liu
 */
public final class OsChinaDefinition implements VendorDefinition<OsChinaSourceSettings> {
    ...
    /**
     * Complete immutable OSChina endpoint, client, capability, form, and deviation definition.
     */
    ...
    /**
     * Creates the stateless OSChina definition used by Vendor directory assembly.
     */
    public OsChinaDefinition() {
     ...
     *
     * @return OSChina Source settings class
     */
    @Override
    public Class<OsChinaSourceSettings> settingsType() {
        return OsChinaSourceSettings.class;
    }
    ...
    /**
     * Resolves the exact default OSChina definition.
     *
