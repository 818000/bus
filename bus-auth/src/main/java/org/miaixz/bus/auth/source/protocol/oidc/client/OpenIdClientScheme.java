 ...
 * @author Kimi Liu
 */
public class OpenIdClientScheme implements ProtocolScheme<OpenIdClientOptions> {
    ...
    private static final Capability.Manifest MANIFEST = new Capability.Manifest(List.of(
            ...
            OAuth2ClientScheme.INTROSPECTION,
            OAuth2ClientScheme.REVOCATION,
            OAuth2ClientScheme.DEVICE_AUTHORIZATION,
            OAuth2ClientScheme.AUTHORIZATION_SERVER_METADATA,
            DISCOVERY,
            JWK_SET,
            USERINFO,
            END_SESSION));
    ...
    /**
     * Creates the stateless OpenID Relying Party profile used to compile Source configurations.
     */
    ...
    private static <Q, S> Capability<Q, S> capability(
        ...
        return new Capability<>(key, requestType, responseType, Capability.Direction.CLIENT, Set.of(interaction),
                security);
    }
    ...
    /**
     * Returns management presentation metadata for a generic OpenID Connect client Source.
     *
     * @return immutable OpenID Connect client metadata
     */
    @Override
    public Metadata metadata() {
        return new Metadata("OpenID Connect Client", "Connects to a standards-based OpenID Provider.", "openid");
    }
