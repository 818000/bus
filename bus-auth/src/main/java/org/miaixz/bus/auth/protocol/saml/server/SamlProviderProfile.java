...
/**
 * Declares the generic SAML 2.0 identity-provider profile.
 * <p>
 * This Provider profile accepts service-provider requests through HTTP-Redirect, returns protocol responses through
 ...
 * @author Kimi Liu
 */
public final class SamlProviderProfile implements ProviderProfile<SamlProviderSettings> {
    ...
    /**
     * Formal specifications implemented by this identity-provider profile.
     */
    ...
    /**
     * External management form containing only deployment settings owned by a SAML Provider.
     */
    ...
    /**
     * Creates the stateless SAML identity-provider profile used to compile server registrations.
     */
    public SamlProviderProfile() {
    ...
    /**
     * Returns the stable SAML Provider profile identifier.
     *
     * @return {@value #ID}
     */
    @Override
     ...
     *
     * @return SAML Provider settings class
     */
    @Override
    public Class<SamlProviderSettings> settingsType() {
        return SamlProviderSettings.class;
    }
    ...
    /**
     * Returns the external management form for SAML identity-provider settings.
     *
     ...
     */
    @Override
    public Optional<SamlProviderSettings> defaults() {
