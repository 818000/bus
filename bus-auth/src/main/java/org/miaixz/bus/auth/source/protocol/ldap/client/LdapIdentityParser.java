...
import org.miaixz.bus.auth.source.protocol.ldap.LdapAttribute;
import org.miaixz.bus.auth.source.protocol.ldap.SearchResultEntry;
...
public class LdapIdentityParser {
     ...
     */
    public Identity map(final String sourceId, final SearchResultEntry input) {
        ...
        return new Identity(sourceId, input.objectName().value(), new JsonValue.ObjectValue(attributes),
                List.of(evidence));
    }
