 ...
 * SecurityBaseline, and identity mapping contracts. It does not host an LDAP server, implement directory persistence,
 * use JNDI, discover arbitrary schemas, follow referrals outside policy, invoke Registry directly, select a Vendor, or
 * expose directory credentials and entries as framework wire values.
 * </p>
 * <p>
