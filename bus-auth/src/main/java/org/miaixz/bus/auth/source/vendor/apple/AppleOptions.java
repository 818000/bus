 ...
 * operation and never caches it in this options object.
 * </p>
 *
 ...
 * @author Kimi Liu
 */
public record AppleOptions(Vendor.Id vendor, Vendor.Variant variant, String clientId, Credential.Reference credential,
        Optional<String> redirectUri, List<String> scopes, String teamId, String keyId)
     ...
     */
    public AppleOptions {
        if (!AppleManifest.ID.equals(vendor) || !AppleManifest.DEFAULT.equals(variant)) {
            throw new ValidateException("Sign in with Apple options must select apple/default");
        }
    ...
    public String toString() {
        return "AppleOptions[vendor=" + vendor + Builder.VARIANT + variant + Builder.REDACTED_SOURCE_OPTIONS + scopes
