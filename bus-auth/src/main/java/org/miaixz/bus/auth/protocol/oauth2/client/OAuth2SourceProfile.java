...
/**
 * Describes the generic standards-based OAuth 2.x client Source profile.
 *
 * @author Kimi Liu
 */
public final class OAuth2SourceProfile implements SourceProfile<OAuth2ClientSettings> {
    ...
    public static final Capability<Void, AuthorizationServerMetadata> AUTHORIZATION_SERVER_METADATA = capability(
            ...
            Capability.Security.PUBLIC);
    /**
     * Exact OAuth 2.x Source operations implemented by this profile.
     */
    ...
    /**
     * Creates the stateless OAuth 2.0 source profile used to compile client registrations.
     */
    public OAuth2SourceProfile() {
     ...
     *
     * @param key   stable platform settings key
     * @param label human-readable field label
    ...
    /**
     * Returns the stable generic OAuth 2.x profile identifier.
     *
     * @return {@value #ID}
     */
    @Override
     ...
     *
     * @return OAuth 2.x client settings class
     */
    @Override
    public Class<OAuth2ClientSettings> settingsType() {
        return OAuth2ClientSettings.class;
    }
     ...
     *
     * @return OAuth 2.x client settings form
     */
    @Override
    public Form form() {
        return FORM;
     ...
     */
    @Override
    public Optional<OAuth2ClientSettings> defaults() {
