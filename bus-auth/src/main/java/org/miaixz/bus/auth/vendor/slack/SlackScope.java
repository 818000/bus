...
public enum SlackScope implements AuthorizeScope {
     ...
     */
    SlackScope(String scope, String description, boolean isDefault) {
        this.scope = scope;
    ...
    /**
     * Returns the human-readable Slack permission description.
     *
    ...
    /**
     * Reports whether clients request this scope by default.
     *
