 ...
 * @author Kimi Liu
 */
public class QqManifest implements VendorManifest<QqOptions> {
     ...
     */
    private static final VendorManifest.Variant MINI_VARIANT = new VendorManifest.Variant(ID, MINI_PROGRAM,
     ...
     *
     * @param variant exact QQ variant whose form is requested
    ...
    public Scheme.Form form(final Vendor.Variant variant) {
        ...
        return OPEN.equals(variant) ? VendorManifest.Forms.extended(
                selected,
                List.of(VendorManifest.Forms.field("preferUnionId", "Prefer UnionID", Scheme.Form.Type.BOOLEAN, false)))
    ...
    public Scheme.Metadata metadata() {
        return new Scheme.Metadata("QQ", "QQ Open Platform and Mini Program authentication", "qq");
    }
