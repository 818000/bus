...
/**
 * Declares the frozen Facebook Login Graph API v26.0 OAuth 2.0 Vendor definition.
 * <p>
 ...
 * @author Kimi Liu
 */
public final class FacebookDefinition implements VendorDefinition<FacebookSourceSettings> {
    ...
    /**
     * Complete immutable Graph API v26.0 endpoint, client, scope, capability, form, and deviation definition.
     */
    private static final VendorDefinition.Definition DEFINITION = new VendorDefinition.Definition(ID, DEFAULT,
            Protocol.OAUTH2, List.of("public_profile", "email"),
            new VendorTargets(
                    Optional.of(
                            fixed(
    ...
    /**
     * Creates the stateless Facebook definition used by Vendor directory assembly.
     */
     ...
     *
     * @return Facebook Source settings class
     */
    @Override
    public Class<FacebookSourceSettings> settingsType() {
        return FacebookSourceSettings.class;
    }
    ...
    /**
     * Returns the exact default Facebook definition.
     *
