 ...
 * @author Kimi Liu
 */
public interface AccessTokenStore extends AtomicStore<String, ExpiringValue<AccessTokenStore.Entry>> {
     ...
     * @author Kimi Liu
     */
    record Entry(String providerId, String clientId, String subjectId, List<String> scope, List<String> audience,
