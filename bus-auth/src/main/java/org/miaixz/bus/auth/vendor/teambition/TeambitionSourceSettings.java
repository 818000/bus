 ...
 * @author Kimi Liu
 */
public record TeambitionSourceSettings(Vendor.Id vendor, Vendor.Variant variant, String clientId,
     ...
     */
    public TeambitionSourceSettings {
        if (!TeambitionDefinition.ID.equals(vendor) || !TeambitionDefinition.DEFAULT.equals(variant)) {
            throw new ValidateException("Teambition settings must select teambition/default");
        }
        ...
        if (redirectUri.isEmpty()) {
            throw new ValidateException("Teambition settings require a registered redirect URI");
        }
    ...
    public String toString() {
        return "TeambitionSourceSettings[vendor=" + vendor + ", variant=" + variant
