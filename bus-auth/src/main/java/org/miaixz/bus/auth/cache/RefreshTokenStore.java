 ...
 * @author Kimi Liu
 */
public interface RefreshTokenStore extends AtomicStore<String, ExpiringValue<RefreshTokenStore.Entry>> {
     ...
     * @author Kimi Liu
     */
    record Entry(String providerId, String clientId, String subjectId, String familyId, long generation,
            List<String> scope, List<String> audience, Optional<String> confirmation,
            Optional<AuthorizationCodeStore.OpenIdBinding> openIdBinding, Status status) {
