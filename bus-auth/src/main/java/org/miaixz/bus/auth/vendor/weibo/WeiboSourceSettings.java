 ...
 * <p>
 * Fixed endpoints and wire deviations remain definition-owned. This record contains the six common Vendor components,
 ...
 * @author Kimi Liu
 */
public record WeiboSourceSettings(Vendor.Id vendor, Vendor.Variant variant, String clientId,
     ...
     * @throws ValidateException        if routing, credential type, callback, or scope violates the frozen definition
     */
    public WeiboSourceSettings {
        if (!WeiboDefinition.ID.equals(vendor) || !WeiboDefinition.DEFAULT.equals(variant)) {
            throw new ValidateException("Weibo settings must select weibo/default");
        }
    ...
    private static void callback(final Optional<String> redirectUri) {
        if (redirectUri.isEmpty()) {
            throw new ValidateException("Weibo settings require a registered redirect URI");
        }
    ...
    public String toString() {
        return "WeiboSourceSettings[vendor=" + vendor + ", variant=" + variant
