 ...
 * @param scopes      ordered requested Proginn scopes, or empty to use the definition default
 * @author Kimi Liu
 */
public record ProginnSourceSettings(Vendor.Id vendor, Vendor.Variant variant, String clientId,
     ...
     */
    public ProginnSourceSettings {
        if (!ProginnDefinition.ID.equals(vendor) || !ProginnDefinition.DEFAULT.equals(variant)) {
            throw new ValidateException("Proginn settings must select proginn/default");
        }
        ...
        if (redirectUri.isEmpty()) {
            throw new ValidateException("Proginn settings require a registered redirect URI");
        }
    ...
    public String toString() {
        return "ProginnSourceSettings[vendor=" + vendor + ", variant=" + variant
