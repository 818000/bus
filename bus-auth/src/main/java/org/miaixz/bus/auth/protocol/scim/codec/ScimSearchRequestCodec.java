...
public class ScimSearchRequestCodec {
     ...
     */
    public ScimSearchRequestCodec(final JsonProvider jsonProvider, final long maximumBytes, final int maximumDepth) {
        this.jsonProvider = Assert.notNull(jsonProvider, "SCIM search JSON provider must not be null");
