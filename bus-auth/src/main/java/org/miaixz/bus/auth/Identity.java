...
/**
 * Aggregates a verified identity and its authentication evidence in the identifier domain of one registered external
 * Source.
 * <p>
 ...
 * </p>
 *
 * @param sourceId   configured Source that established the identity
 * @param subject    stable subject identifier within that Source
 * @param attributes immutable implementation-neutral identity attributes
 * @param evidence   immutable verified authentication evidence
 * @author Kimi Liu
 */
public record Identity(String sourceId, String subject, JsonValue.ObjectValue attributes, List<Evidence> evidence) {
     ...
     * @param attributes implementation-neutral identity attributes
     ...
     * validates the source value. It records a safe derived claim and verification provenance, never a raw password,
     * token, assertion, private platform response, or other credential material.
     * </p>
     *
    ...
    public record Evidence(Type type, Strength strength, Claim claim) {
         ...
         * @param value      immutable implementation-neutral verified value
        ...
        public record Claim(String name, JsonValue value, String issuer, Instant verifiedAt) {
             ...
             * @param value      implementation-neutral verified value
