...
/**
 * Declares the Taobao OAuth 2.0 browser Vendor definition.
 * <p>
 ...
 * @author Kimi Liu
 */
public final class TaobaoDefinition implements VendorDefinition<TaobaoSourceSettings> {
    ...
    /**
     * Complete immutable Taobao endpoint, client, capability, form, and deviation definition.
     */
    ...
    /**
     * Creates the stateless Taobao definition used by Vendor directory assembly.
     */
    public TaobaoDefinition() {
     ...
     *
     * @return Taobao Source settings class
     */
    @Override
    public Class<TaobaoSourceSettings> settingsType() {
        return TaobaoSourceSettings.class;
    }
    ...
    /**
     * Resolves the exact default Taobao definition.
     *
