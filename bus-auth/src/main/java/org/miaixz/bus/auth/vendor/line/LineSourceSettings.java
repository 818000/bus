 ...
 * <p>
 * Official endpoints, issuer, PKCE policy, and ID Token algorithms remain definition-owned. The immutable settings keep
 ...
 * @author Kimi Liu
 */
public record LineSourceSettings(Vendor.Id vendor, Vendor.Variant variant, String clientId,
     ...
     *                                  definition
     */
    public LineSourceSettings {
        if (!LineDefinition.ID.equals(vendor) || !LineDefinition.DEFAULT.equals(variant)) {
            throw new ValidateException("LINE settings must select line/default");
        }
        ...
        if (redirectUri.isEmpty()) {
            throw new ValidateException("LINE settings require a registered redirect URI");
        }
    ...
    public String toString() {
        return "LineSourceSettings[vendor=" + vendor + ", variant=" + variant
