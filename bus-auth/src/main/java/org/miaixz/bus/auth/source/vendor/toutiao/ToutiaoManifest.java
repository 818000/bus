 ...
 * @author Kimi Liu
 */
public class ToutiaoManifest implements VendorManifest<ToutiaoOptions> {
    ...
    /**
     * Creates the stateless Toutiao manifest used by Vendor module assembly.
     */
    ...
    public Scheme.Metadata metadata() {
        return new Scheme.Metadata("Toutiao", "Toutiao account authorization", "toutiao");
    }
