...
public enum GitlabScope implements AuthorizeScope {
    ...
    WRITE_REGISTRY("write_registry",
            "<span title=\"translation missing: en.doorkeeper.scope_desc.write_registry\">Write BuiltinVendors</span>",
            false),
    /**
     ...
     */
    GitlabScope(String scope, String description, boolean isDefault) {
        this.scope = scope;
    ...
    /**
     * Returns the immutable GitLab wire scope.
     *
