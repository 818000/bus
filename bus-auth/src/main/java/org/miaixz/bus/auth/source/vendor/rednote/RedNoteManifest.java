 ...
 * @author Kimi Liu
 */
public class RedNoteManifest implements VendorManifest<RedNoteOptions> {
     ...
     */
    private static final VendorManifest.Variant VARIANT = new VendorManifest.Variant(ID, MARKETING, Protocol.HTTPS,
            VendorManifest.Pkce.DISABLED, Credential.Type.CLIENT_SECRET, List.of("report_service"),
    ...
    public Scheme.Metadata metadata() {
        return new Scheme.Metadata("Xiaohongshu Marketing", "Xiaohongshu marketing account authorization",
                "rednote-marketing");
    }
