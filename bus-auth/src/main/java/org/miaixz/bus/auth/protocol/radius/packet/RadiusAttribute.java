...
public record RadiusAttribute(int type, long vendorId, byte[] value) {
     ...
     * @param value    value
     * @throws ValidateException if type, vendor identifier, value length, or vendor shape is invalid
     */
     ...
     * @return attribute
     * @throws ValidateException if type or value is invalid
     */
     ...
     * @return attribute
     * @throws ValidateException if the vendor identifier or payload is invalid
     */
