...
/**
 * Declares the RADIUS Access and Accounting server scheme implemented by the RADIUS Source driver.
 * <p>
 * Both capabilities retain complete binary packet models. The Roster security boundary is public because RADIUS
 ...
 * @author Kimi Liu
 */
public class RadiusServerScheme implements ProtocolScheme<RadiusServerOptions> {

    /**
     * Stable Source type identifier for RADIUS servers.
     */
    ...
    public static final Capability<AccessRequest, RadiusPacket> ACCESS = new Capability<>(Radius.ACCESS,
            AccessRequest.class, RadiusPacket.class, Capability.Direction.SERVER, Set.of(Capability.Interaction.DIRECT),
    ...
    public static final Capability<AccountingRequest, AccountingResponse> ACCOUNTING = new Capability<>(
            Radius.ACCOUNTING, AccountingRequest.class, AccountingResponse.class, Capability.Direction.SERVER,
    ...
    /**
     * Formal standards implemented by the RADIUS server.
     */
    ...
    private static final Form FORM = new Form(List.of(
            new Form.Section("radius-provider", "RADIUS server",
                    List.of(
    ...
    /**
     * Returns the stable RADIUS server-role Source configuration type.
     *
     * @return {@value #ID}
     */
    @Override
    ...
    /**
     * Returns management presentation metadata for a RADIUS authentication server.
     *
     * @return immutable RADIUS server metadata
     */
    @Override
    public Metadata metadata() {
        return new Metadata("RADIUS Server", "Exposes framework authentication through a RADIUS server endpoint.",
                "radius");
    }

    /**
     * Returns the RADIUS server category.
     *
     * @return RADIUS server type
     */
    @Override
