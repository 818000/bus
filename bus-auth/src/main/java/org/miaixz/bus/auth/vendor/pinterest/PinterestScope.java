...
public enum PinterestScope implements AuthorizeScope {
     ...
     */
    PinterestScope(String scope, String description, boolean isDefault) {
        this.scope = scope;
    ...
    /**
     * Returns the immutable Pinterest wire value sent in an authorization request.
     *
     ...
     *
     * @return {@code true} only for public read access
     */
    @Override
