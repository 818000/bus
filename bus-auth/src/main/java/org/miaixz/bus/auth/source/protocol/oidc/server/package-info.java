 ...
 * {@link org.miaixz.bus.auth.source.protocol.oidc.server.OpenIdServerScheme} composes the implemented OIDC capabilities
 * with the OAuth token-side capabilities declared by its options.
 * </p>
 * <p>
 * This package consumes OIDC and OAuth models and codecs, verified client and subject context, consent and claim ports,
 * ID Token issuance, JOSE/JWT signing, session state, Policies, and Fabric transport. It does not implement client
 * registration, project persistence, end-user authentication, permission checks, Vendor behavior, or Roster lookup, and
 * it never serializes Outcome, Context, Timeout, exceptions, or Bus errors as an OIDC response.
 * </p>
 * <p>
