...
public enum QqScope implements AuthorizeScope {
     ...
     */
    QqScope(String scope, String description, boolean isDefault) {
        this.scope = scope;
    ...
    /**
     * Returns the immutable QQ wire scope.
     *
    ...
    /**
     * Returns the immutable grant description.
     *
     ...
     *
     * @return {@code true} only for profile access
     */
    @Override
