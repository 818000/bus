 ...
 * from the compiled Registry and therefore publish only operations and algorithms actually enabled for one Provider.
 * Dynamic client registration and OIDC-only metadata are deliberately excluded from this OAuth model.
 * </p>
 *
