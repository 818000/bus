 ...
 * <p>
 * This immutable record keeps only public configuration values and an external client-secret reference. Fixed platform
...
public record AliyunOptions(Vendor.Id vendor, Vendor.Variant variant, String clientId, Credential.Reference credential,
    ...
    /**
     * Validates and freezes one Alibaba Cloud Source configuration without resolving its external secret.
     *
