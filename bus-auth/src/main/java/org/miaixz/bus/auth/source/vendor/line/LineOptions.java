...
/**
 * Carries externally managed LINE Login channel configuration values.
 * <p>
...
public record LineOptions(Vendor.Id vendor, Vendor.Variant variant, String clientId, Credential.Reference credential,
    ...
    public String toString() {
        return "LineOptions[vendor=" + vendor + Builder.VARIANT + variant + Builder.REDACTED_SOURCE_OPTIONS + scopes
