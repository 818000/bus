 ...
 * <p>
 * Fixed endpoints and platform wire deviations remain definition-owned. This immutable record retains only the public
 ...
 * @author Kimi Liu
 */
public record OsChinaSourceSettings(Vendor.Id vendor, Vendor.Variant variant, String clientId,
     ...
     */
    public OsChinaSourceSettings {
        if (!OsChinaDefinition.ID.equals(vendor) || !OsChinaDefinition.DEFAULT.equals(variant)) {
            throw new ValidateException("OSChina settings must select oschina/default");
        }
        ...
        if (redirectUri.isEmpty()) {
            throw new ValidateException("OSChina settings require a registered redirect URI");
        }
    ...
    public String toString() {
        return "OsChinaSourceSettings[vendor=" + vendor + ", variant=" + variant
