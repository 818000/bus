...
/**
 * Dialect implementation for XuguDB databases.
 *
 * <p>
 * XuguDB uses standard {@code LIMIT/OFFSET} pagination in this framework and is grouped with the
 ...
 * @since Java 21+
 */
public class Xugudb extends AbstractDialect {

    /**
     * Creates the XuguDB dialect.
     */
    public Xugudb() {
        super("Xugudb", "jdbc:xugu:");
    }

    /**
     * Returns the UPSERT family used by XuguDB in this framework.
     *
    ...
    protected String modifyColumn(TableMeta table, ColumnMeta column) {
        return modifyColumn(table, column, Modify.MODIFY);
    }
