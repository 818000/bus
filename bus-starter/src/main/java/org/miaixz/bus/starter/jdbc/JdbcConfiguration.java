...
public class JdbcConfiguration {
    ...
    public DynamicDataSource dataSource() {
        ...
        if (ObjectKit.isNotEmpty(this.properties.getMulti())) {
            Logger.info(false, "Starter", "component=jdbc, DataSource enable support for multiple data sources");
            ...
            for (String key : beanMap.keySet()) {
                ...
                if (StringKit.isNotEmpty(this.properties.getPrivateKey())) {
                    Logger.info(
                            true,
                            "Starter",
                            "component=jdbc, DataSource the database connection is securely enabled");
