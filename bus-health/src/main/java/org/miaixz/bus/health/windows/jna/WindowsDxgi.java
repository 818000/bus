...
public final class WindowsDxgi {
    ...
    static {
        ...
        try {
            ...
            Logger.debug(false, "Health", "dxgi.dll not available: {}", e.getClass().getSimpleName());
        } catch (NoClassDefFoundError e) {
            Logger.debug(false, "Health", "JNA DxgiLib class failed to load: {}", e.getClass().getSimpleName());
        }
                ...
                try {
                    ...
                    if (COMUtils.SUCCEEDED(descHr)) {
                        ...
                        Logger.debug(
                                ...
                                i,
                                name,
                                Integer.toHexString(desc.VendorId),
                                Integer.toHexString(desc.DeviceId),
                                vram,
     ...
     */
    public static DxgiAdapterInfo findMatch(
            List<DxgiAdapterInfo> adapters,
            int vendorId,
            int deviceId,
            String adapterName) {
