...
public final class Formats {
    ...
    /**
     * Normalizes a MAC address string to colon-separated uppercase hexadecimal.
     *
    ...
    /**
     * Returns whether the string contains only hexadecimal characters.
     *
     * @param s the string to test
     * @return {@code true} if the string is hexadecimal, {@code false} otherwise
     */
