 ...
 *
 * <p>
 * Populated by {@link WindowsDxgi#queryAdapters()} and used by {@link WindowsGraphicsCard} to supply accurate VRAM
...
public final class DxgiAdapterInfo {
    ...
    public String toString() {
        return String.format(
                Locale.ROOT,
                "DxgiAdapterInfo{desc='%s', vendor=0x%04X, device=0x%04X, vram=%d, luid=0x%08X_0x%08X}",
                description,
                vendorId,
                deviceId,
